...
public class ServerPluginEnableDisableException extends ServerPluginException {
  ...
  public ServerPluginEnableDisableException(String message, Throwable cause,
  ...
  protected ServerPluginEnableDisableException(String message, Throwable cause,
      boolean enableSuppression, boolean writableStackTrace, Plugin responsiblePlugin) {
