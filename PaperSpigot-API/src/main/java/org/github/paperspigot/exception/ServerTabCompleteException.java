...
public class ServerTabCompleteException extends ServerCommandException {
  ...
  public ServerTabCompleteException(String message, Throwable cause, Command command,
      CommandSender commandSender, String[] arguments) {
    super(message, cause, command, commandSender, arguments);
  }

  public ServerTabCompleteException(Throwable cause, Command command, CommandSender commandSender,
      String[] arguments) {
    super(cause, command, commandSender, arguments);
  }

  protected ServerTabCompleteException(String message, Throwable cause, boolean enableSuppression,
