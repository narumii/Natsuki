...
public class ServerEventException extends ServerPluginException {
  ...
  public ServerEventException(String message, Throwable cause, Plugin responsiblePlugin,
  ...
  public ServerEventException(Throwable cause, Plugin responsiblePlugin, Listener listener,
      Event event) {
