...
public interface Configuration extends ConfigurationSection {
   ...
   * MemoryConfiguration} will be created to hold the new default value.
   * <p>
   * This method will not hold a reference to the specified Configuration, nor will it automatically
   * update if that Configuration ever changes. If you require this, you should set the default
   * source with {@link #setDefaults(org.bukkit.configuration.Configuration)}.
   *
