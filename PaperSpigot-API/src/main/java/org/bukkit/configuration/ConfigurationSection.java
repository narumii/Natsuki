...
public interface ConfigurationSection {
   ...
   * <p>
   * If deep is set to true, then this will contain all the keys and values within any child {@link
   * ConfigurationSection}s (and their children, etc). These keys will be in a valid path notation
   * for you to use.
   * <p>
   ...
   * <p>
   * If the section is no longer contained within its parent for any reason, such as being replaced
   * with a different value, this may return null.
   *
   ...
   * <p>
   * If the Object does not exist then the specified default value will returned regardless of if a
   ...
   * <p>
   * If value is null, the entry will be removed. Any existing entry will be replaced, regardless of
   * what the new value is.
   * <p>
   * Some implementations may have limitations on what you may store. See their individual javadocs
   * for details. No implementations should allow you to store {@link Configuration}s or {@link
   * ConfigurationSection}s, please use {@link #createSection(java.lang.String)} for that.
   *
   ...
   * <p>
   * If the String does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the String to get.
   ...
   * will check if that default value is a String and return appropriately.
   *
   ...
   * <p>
   * If the int does not exist but a default value has been specified, this will return the default
   * value. If the int does not exist and no default value was specified, this will return 0.
   *
   ...
   * <p>
   * If the int does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the int to get.
   ...
   * <p>
   * If the path exists but is not a int, this will return false. If the path does not exist, this
   * will return false. If the path does not exist but a default value has been specified, this will
   * check if that default value is a int and return appropriately.
   *
   ...
   * <p>
   * If the boolean does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the boolean to get.
   ...
   * <p>
   * If the double does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the double to get.
   ...
   * <p>
   * If the float does not exist but a default value has been specified, this will return the
   * default value. If the float does not exist and no default value was specified, this will return
   * 0.
   *
   ...
   * <p>
   * If the float does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the float to get.
   ...
   * <p>
   * If the path exists but is not a float, this will return false. If the path does not exist, this
   * will return false. If the path does not exist but a default value has been specified, this will
   * check if that default value is a gloat and return appropriately.
   *
   ...
   * <p>
   * If the long does not exist but a default value has been specified, this will return the default
   * value. If the long does not exist and no default value was specified, this will return 0.
   *
   ...
   * <p>
   * If the long does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the long to get.
   ...
   * <p>
   * If the path exists but is not a long, this will return false. If the path does not exist, this
   * will return false. If the path does not exist but a default value has been specified, this will
   * check if that default value is a long and return appropriately.
   *
   ...
   * <p>
   * If the List does not exist but a default value has been specified, this will return the default
   * value. If the List does not exist and no default value was specified, this will return null.
   *
   ...
   * <p>
   * If the List does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the List to get.
   ...
   * <p>
   * If the path exists but is not a List, this will return false. If the path does not exist, this
   * will return false. If the path does not exist but a default value has been specified, this will
   * check if that default value is a List and return appropriately.
   *
   ...
   * <p>
   * If the List does not exist but a default value has been specified, this will return the default
   * value. If the List does not exist and no default value was specified, this will return an empty
   * List.
   * <p>
   * This method will attempt to cast any values into a String if possible, but may miss any values
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Integer if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Boolean if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Double if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Float if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Long if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Byte if possible, but may miss any values
   * out if they are not compatible.
   *
   * @param path Path of the List to get.
   ...
   * List.
   * <p>
   * This method will attempt to cast any values into a Map if possible, but may miss any values out
   ...
   * <p>
   * If the Vector does not exist but a default value has been specified, this will return the
   * default value. If the Vector does not exist and no default value was specified, this will
   * return null.
   *
   ...
   * <p>
   * If the Vector does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the Vector to get.
   ...
   * <p>
   * If the path exists but is not a Vector, this will return false. If the path does not exist,
   * this will return false. If the path does not exist but a default value has been specified, this
   * will check if that default value is a Vector and return appropriately.
   *
   ...
   * <p>
   * If the OfflinePlayer does not exist but a default value has been specified, this will return
   * the default value. If the OfflinePlayer does not exist and no default value was specified, this
   * will return null.
   *
   ...
   * <p>
   * If the OfflinePlayer does not exist then the specified default value will returned regardless
   * of if a default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the OfflinePlayer to get.
   ...
   * exist, this will return false. If the path does not exist but a default value has been
   * specified, this will check if that default value is a OfflinePlayer and return appropriately.
   *
   ...
   * <p>
   * If the ItemStack does not exist but a default value has been specified, this will return the
   * default value. If the ItemStack does not exist and no default value was specified, this will
   * return null.
   *
   ...
   * <p>
   * If the ItemStack does not exist then the specified default value will returned regardless of if
   ...
   * <p>
   * If the path exists but is not a ItemStack, this will return false. If the path does not exist,
   * this will return false. If the path does not exist but a default value has been specified, this
   * will check if that default value is a ItemStack and return appropriately.
   *
   ...
   * <p>
   * If the Color does not exist but a default value has been specified, this will return the
   * default value. If the Color does not exist and no default value was specified, this will return
   * null.
   *
   ...
   * <p>
   * If the Color does not exist then the specified default value will returned regardless of if a
   * default has been identified in the root {@link Configuration}.
   *
   * @param path Path of the Color to get.
   * @param def The default value to return if the path is not found or is not a Color.
   * @return Requested Color.
   */
   ...
   * <p>
   * If the path exists but is not a Color, this will return false. If the path does not exist, this
   * will return false. If the path does not exist but a default value has been specified, this will
   * check if that default value is a Color and return appropriately.
   *
   ...
   * <p>
   * If the path exists but is not a ConfigurationSection, this will return false. If the path does
   * not exist, this will return false. If the path does not exist but a default value has been
   ...
   * in {@link #getRoot()}.
   * <p>
   * If the root contains no defaults, or the defaults doesn't contain a value for this path, or the
   * value at this path is not a {@link ConfigurationSection} then this will return null.
   *
