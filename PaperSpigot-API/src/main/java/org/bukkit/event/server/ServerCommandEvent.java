...
/**
 * This event is called when a command is run from the server console. It is called early in the
 * command handling process, and modifications in this event (via {@link #setCommand(String)}) will
 * be shown in the behavior.
 * <p>
