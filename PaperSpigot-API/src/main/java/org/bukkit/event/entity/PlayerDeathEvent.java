...
public class PlayerDeathEvent extends EntityDeathEvent {
  ...
  public PlayerDeathEvent(final Player player, final List<ItemStack> drops, final int droppedExp,
      final int newExp, final String deathMessage) {
    this(player, drops, droppedExp, newExp, 0, 0, deathMessage);
  }

  public PlayerDeathEvent(final Player player, final List<ItemStack> drops, final int droppedExp,
      final int newExp, final int newTotalExp, final int newLevel, final String deathMessage) {
   ...
   * <p>
   * This does not indicate how much EXP should be dropped, please see {@link #getDroppedExp()} for
   * that.
   *
   ...
   * <p>
   * This does not indicate how much EXP should be dropped, please see {@link #setDroppedExp(int)}
   * for that.
   *
   ...
   * <p>
   * This doesn't prevent prevent the EXP from dropping. {@link #setDroppedExp(int)} should be used
   * stop the EXP from dropping.
   *
