...
public class EntityDamageEvent extends EntityEvent implements Cancellable {
  ...
  public EntityDamageEvent(final Entity damagee, final DamageCause cause, final double damage) {
    this(damagee, cause,
        new EnumMap<DamageModifier, Double>(ImmutableMap.of(DamageModifier.BASE, damage)),
        new EnumMap<DamageModifier, Function<? super Double, Double>>(
            ImmutableMap.of(DamageModifier.BASE, ZERO)));
  }

  public EntityDamageEvent(final Entity damagee, final DamageCause cause,
   ...
   * @throws IllegalArgumentException if type is null
   * @throws UnsupportedOperationException if the caller does not support the particular
   * DamageModifier, or to rephrase, when {@link #isApplicable(DamageModifier)} returns false
   * @see #getFinalDamage()
   */
  ...
  /**
   * This checks to see if a particular modifier is valid for this event's caller, such that, {@link
   * #setDamage(DamageModifier, double)} will not throw an {@link UnsupportedOperationException}.
   * <p>
   ...
   * <p>
   * For compatibility this also recalculates the modifiers and scales them by the difference
   * between the modifier for the previous damage value and the new one.
   *
  ...
  public enum DamageModifier {
    /**
     * This represents the amount of damage being done, also known as the raw {@link
    ...
    HARD_HAT,
    /**
     * This represents  the damage reduction caused by blocking, only present for {@link Player
     * Players}.
     */
    BLOCKING,
    /**
