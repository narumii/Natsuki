 ...
 * <p>
 * This event allows you to modify the velocity of the entity after they have successfully exited
 * the portal.
 */
public class EntityPortalExitEvent extends EntityTeleportEvent {
  ...
  public EntityPortalExitEvent(final Entity entity, final Location from, final Location to,
      final Vector before, final Vector after) {
