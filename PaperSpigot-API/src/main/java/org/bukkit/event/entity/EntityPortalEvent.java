...
public class EntityPortalEvent extends EntityTeleportEvent {
  ...
  public EntityPortalEvent(final Entity entity, final Location from, final Location to,
      final TravelAgent pta) {
   ...
   * <p>
   * If this is set to true, the TravelAgent will try to find a Portal at the {@link #getTo()}
   * Location, and will try to create one if there is none.
   * <p>
   * If this is set to false, the {@link #getEntity()} will only be teleported to the {@link
   * #getTo()} Location.
   *
