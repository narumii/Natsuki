...
public class EntityTargetEvent extends EntityEvent implements Cancellable {
   ...
   * <p>
   * This is different from cancelling the event. Cancelling the event will cause the entity to keep
   * an original target, while setting to be null will cause the entity to be reset.
   *
  ...
  public enum TargetReason {
    ...
    /**
     * When the target attacks a fellow pig zombie, so the whole group will target him with this
     * reason.
     */
    PIG_ZOMBIE_TARGET,
    /**
    ...
    /**
     * When a zombie targeting an entity summons reinforcements, so the reinforcements target the
     * same entity
     */
