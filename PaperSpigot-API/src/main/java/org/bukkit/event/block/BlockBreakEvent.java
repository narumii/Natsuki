 ...
 * <p>
 * If you wish to have the block drop experience, you must set the experience value above 0. By
 * default, experience will be set in the event if:
 * <ol>
 ...
 * </ol>
 * <p>
 * Note: Plugins wanting to simulate a traditional block drop should set the block to air and
 * utilize their own methods for determining what the default drop for the block being broken is and
