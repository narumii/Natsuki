...
public class BlockPistonExtendEvent extends BlockPistonEvent {
  ...
  public BlockPistonExtendEvent(final Block block, final List<Block> blocks,
   ...
   * @deprecated slime blocks make the value of this method inaccurate due to blocks being pushed at
   * the side
   */
  @Deprecated
