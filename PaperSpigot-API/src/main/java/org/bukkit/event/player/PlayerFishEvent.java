...
public class PlayerFishEvent extends PlayerEvent implements Cancellable {
   ...
   * @deprecated replaced by {@link #PlayerFishEvent(Player, Entity, Fish, State)} to include the
   * {@link Fish} hook entity.
   */
  @Deprecated
  ...
  public PlayerFishEvent(final Player player, final Entity entity, final Fish hookEntity,
      final State state) {
    super(player);
    this.entity = entity;
   ...
   *
   * @return Entity caught by the player, Entity if fishing, and null if bobber has gotten stuck in
   * the ground or nothing has been caught
   */
