...
public class PlayerLoginEvent extends PlayerEvent {
   ...
   * @param message The message to be displayed if result denies login
   */
  public PlayerLoginEvent(final Player player, String hostname, final InetAddress address,
      final Result result, final String message, final InetAddress realAddress) { // Spigot
  ...
  /**
   * Gets the {@link InetAddress} for the Player associated with this event. This method is provided
   * as a workaround for player.getAddress() returning null during PlayerLoginEvent.
   *
   * @return The address for this player. For legacy compatibility, this may be null.
   */
