...
public class PlayerMoveEvent extends PlayerEvent implements Cancellable {
   ...
   * <p>
   * If a move or teleport event is cancelled, the player will be moved or teleported back to the
   * Location as defined by getFrom(). This will not fire an event
   *
  ...
  private void validateLocation(Location loc) {
    ...
    Preconditions
        .checkArgument(loc.getWorld() != null, "Cannot use null location with null world!");
  }
