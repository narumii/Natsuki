...
public class PlayerEggThrowEvent extends PlayerEvent {
  ...
  public PlayerEggThrowEvent(final Player player, final Egg egg, final boolean hatching,
      final byte numHatches, final EntityType hatchingType) {
    super(player);
    this.egg = egg;
  ...
  @Deprecated
  public PlayerEggThrowEvent(Player player, Egg egg, boolean hatching, byte numHatches,
  ...
  /**
   * Gets whether the egg is hatching or not. Will be what the server would've done without
   * interaction.
   *
  ...
  /**
   * Get the number of mob hatches from the egg. By default the number will be the number the server
   * would've done
   * <ul>
   ...
   * <p>
   * The boolean hatching will override this number. Ie. If hatching = false, this number will not
   * matter
   *
