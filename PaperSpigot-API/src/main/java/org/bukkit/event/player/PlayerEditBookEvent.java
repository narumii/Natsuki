...
/**
 * Called when a player edits or signs a book and quill item. If the event is cancelled, no changes
 * are made to the BookMeta
 */
public class PlayerEditBookEvent extends PlayerEvent implements Cancellable {
   ...
   * <p>
   * Note: this is a copy of the book meta. You cannot use this object to change the existing book
   * meta.
   *
   ...
   * <p>
   * Note: this is a copy of the proposed new book meta. Use {@link #setNewBookMeta(BookMeta)} to
   * change what will actually be added to the book.
   *
  ...
  /**
   * Gets whether or not the book is being signed. If a book is signed the Material changes from
   * BOOK_AND_QUILL to WRITTEN_BOOK.
   *
  ...
  /**
   * Sets whether or not the book is being signed. If a book is signed the Material changes from
   * BOOK_AND_QUILL to WRITTEN_BOOK.
   *
