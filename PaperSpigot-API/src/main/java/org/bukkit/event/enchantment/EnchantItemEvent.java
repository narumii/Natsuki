...
public class EnchantItemEvent extends InventoryEvent implements Cancellable {
  ...
  public EnchantItemEvent(final Player enchanter, final InventoryView view, final Block table,
      final ItemStack item, final int level, final Map<Enchantment, Integer> enchants,
      final int i) {
    super(view);
  ...
  /**
   * Get map of enchantment (levels, keyed by type) to be added to item (modify map returned to
   * change values). Note: Any enchantments not allowed for the item will be ignored
   *
