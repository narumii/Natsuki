...
public class PrepareItemEnchantEvent extends InventoryEvent implements Cancellable {
  ...
  public PrepareItemEnchantEvent(final Player enchanter, InventoryView view, final Block table,
      final ItemStack item, final int[] levelsOffered, final int bonus) {
    super(view);
