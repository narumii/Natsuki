...
/**
 * A delegate for handling block changes. This serves as a direct interface between generation
 * algorithms in the server implementation and utilizing code.
 */
public interface BlockChangeDelegate {

  /**
   * Set a block type at the specified coordinates without doing all world updates and
   * notifications.
   * <p>
  ...
  /**
   * Set a block type and data at the specified coordinates without doing all world updates and
   * notifications.
   * <p>
   * It is safe to have this call World.setTypeId, but it may be slower than World.setRawTypeId.
   *
