 ...
 * <p>
 * An implementation will handle the creation and application for ItemMeta. This class should not be
 * implemented by a plugin in a live environment.
 */
public interface ItemMeta extends Cloneable, ConfigurationSerializable {
   ...
   * <p>
   * Plugins should check that hasDisplayName() returns <code>true</code> before calling this
   * method.
   *
   ...
   * @param ignoreLevelRestriction this indicates the enchantment should be applied, ignoring the
   * level limit
  ...
  /**
   * Set itemflags which should be ignored when rendering a ItemStack in the Client. This Method
   * does silently ignore double set itemFlags.
   *
  ...
  /**
   * Remove specific set of itemFlags. This tells the Client it should render it again. This Method
   * does silently ignore double removed itemFlags.
   *
