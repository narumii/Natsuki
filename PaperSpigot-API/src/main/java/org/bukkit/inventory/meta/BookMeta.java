...
/**
 * Represents a book ({@link Material#BOOK_AND_QUILL} or {@link Material#WRITTEN_BOOK}) that can
 * have a title, an author, and pages.
 */
public interface BookMeta extends ItemMeta {
  ...
  /**
   * Clears the existing book pages, and sets the book to use the provided pages. Maximum 50 pages
  ...
  /**
   * Adds new pages to the end of the book. Up to a maximum of 50 pages with 256 characters per
   * page.
   *
   * @param pages A list of strings, each being a page
   */
