...
public interface FireworkMeta extends ItemMeta {
   ...
   * @throws IllegalArgumentException If any effect is null (may be thrown after changes have
   * occurred)
   */
  ...
  /**
   * Sets the approximate power of the firework. Each level of power is half a second of flight
   * time.
   *
