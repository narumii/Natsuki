...
/**
 * EnchantmentMeta is specific to items that can <i>store</i> enchantments, as opposed to being
 * enchanted. {@link Material#ENCHANTED_BOOK} is an example of an item with enchantment storage.
 */
