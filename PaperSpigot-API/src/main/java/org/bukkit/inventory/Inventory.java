...
public interface Inventory extends Iterable<ItemStack> {
  ...
  /**
   * Checks if the inventory contains any ItemStacks with the given materialId, adding to at least
   ...
   * in that slot. If no matching ItemStack with the given materialId is found, an empty map is
   * returned.
   *
