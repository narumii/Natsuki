...
/**
 * Represents a shapeless recipe, where the arrangement of the ingredients on the crafting grid does
 * not matter.
 */
public class ShapelessRecipe implements Recipe {
  ...
  /**
   * Create a shapeless recipe to craft the specified ItemStack. The constructor merely determines
  ...
  /**
   * Removes an ingredient from the list. If the ingredient occurs multiple times, only one instance
   * of it is removed. Only removes exact matches, with a data value of 0.
   *
  ...
  /**
   * Removes an ingredient from the list. If the ingredient occurs multiple times, only one instance
   * of it is removed. If the data value is -1, only ingredients with a -1 data value will be
   * removed.
   *
   * @param ingredient The ingredient to remove
   * @return The changed recipe.
  ...
  /**
   * Removes multiple instances of an ingredient from the list. If there are less instances then
   * specified, all will be removed. Only removes exact matches, with a data value of 0.
   *
  ...
  /**
   * Removes multiple instances of an ingredient from the list. If there are less instances then
   * specified, all will be removed. If the data value is -1, only ingredients with a -1 data value
   * will be removed.
   *
   * @param count The number of copies to remove.
   * @param ingredient The ingredient to remove.
