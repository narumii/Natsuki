...
public class ItemStack implements Cloneable, ConfigurationSerializable {
    ...
    if (data == null || mat == null || mat.getData() == null) {
      ...
      if ((data.getClass() == mat.getData()) || (data.getClass() == MaterialData.class)) {
        ...
        throw new IllegalArgumentException(
            "Provided data is not of type " + mat.getData().getName() + ", found " + data.getClass()
                .getName());
      }
    }
  }
  ...
  /**
   * Get the maximum stacksize for the material hold in this ItemStack. (Returns -1 if it has no
   * idea)
   *
  ...
  public boolean isSimilar(ItemStack stack) {
    ...
    return getTypeId() == stack.getTypeId() && getDurability() == stack.getDurability()
        && hasItemMeta() == stack.hasItemMeta() && (!hasItemMeta() || Bukkit.getItemFactory()
        .equals(getItemMeta(), stack.getItemMeta()));
  }
  ...
  public final int hashCode() {
    ...
    hash = hash * 31 + (hasItemMeta() ? (meta == null ? getItemMeta().hashCode() : meta.hashCode())
        : 0);
   ...
   * <p>
   * This method is the same as calling {@link #addEnchantment(org.bukkit.enchantments.Enchantment,
   * int)} for each element of the map.
   *
   * @param enchantments Enchantments to add
   * @throws IllegalArgumentException if the specified enchantments is null
   * @throws IllegalArgumentException if any specific enchantment or level is null. <b>Warning</b>:
   ...
   * <p>
   * If this item stack already contained the given enchantment (at any level), it will be
   * replaced.
   *
  ...
  public void addEnchantment(Enchantment ench, int level) {
    ...
    if ((level < ench.getStartLevel()) || (level > ench.getMaxLevel())) {
      throw new IllegalArgumentException(
          "Enchantment level is either too low or too high (given " + level + ", bounds are " + ench
              .getStartLevel() + " to " + ench.getMaxLevel() + ")");
   ...
   * <p>
   * This method is the same as calling {@link #addUnsafeEnchantment(org.bukkit.enchantments.Enchantment,
   * int)} for each element of the map.
   *
   * @param enchantments Enchantments to add
   */
  ...
  public void addUnsafeEnchantment(Enchantment ench, int level) {
    (meta == null ? meta = Bukkit.getItemFactory().getItemMeta(getType0()) : meta)
  ...
  public ItemMeta getItemMeta() {
    return this.meta == null ? Bukkit.getItemFactory().getItemMeta(getType0()) : this.meta;
  }
   ...
   * @return True if successfully applied ItemMeta, see {@link ItemFactory#isApplicable(ItemMeta,
   * ItemStack)}
