...
/**
 * A score entry for an {@link #getEntry() entry} on an {@link #getObjective() objective}. Changing
 * this will not affect any other objective or scoreboard.
 */
public interface Score {
   ...
   *
   * @return the owning objective's scoreboard, or null if it has been {@link Objective#unregister()
   * unregistered}
   */
