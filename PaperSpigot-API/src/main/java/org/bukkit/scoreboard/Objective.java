...
/**
 * An objective on a scoreboard that can show scores specific to entries. This objective is only
 * relevant to the display of the associated {@link #getScoreboard() scoreboard}.
 */
public interface Objective {
  ...
  /**
   * Sets this objective to display on the specified slot for the scoreboard, removing it from any
   * other display slot.
   *
