  ...
  public boolean execute(CommandSender sender, String currentAlias, String[] args) {
    ...
    if (statisticString.equals("*")) {
      for (Achievement achievement : Achievement.values()) {
        ...
        PlayerAchievementAwardedEvent event = new PlayerAchievementAwardedEvent(player,
            achievement);
    ...
    if (achievement != null) {
      ...
      if (event.isCancelled()) {
        sender.sendMessage(String
            .format("Unable to award %s the achievement %s", player.getName(), statisticString));
        return true;
      }
      player.awardAchievement(achievement);
  ...
  public List<String> tabComplete(CommandSender sender, String alias, String[] args)
    ...
    if (args.length == 2) {
      return Bukkit.getUnsafe()
          .tabCompleteInternalStatisticOrAchievementName(args[1], new ArrayList<String>());
    }
