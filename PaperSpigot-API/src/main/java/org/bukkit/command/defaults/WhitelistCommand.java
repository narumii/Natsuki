...
public class WhitelistCommand extends VanillaCommand {
  ...
  private static final List<String> WHITELIST_SUBCOMMANDS = ImmutableList
      .of("add", "remove", "on", "off", "list", "reload");
    ...
    if (args.length == 1) {
      ...
      if (args[0].equalsIgnoreCase("add")) {
        ...
        for (OfflinePlayer player : Bukkit
            .getOnlinePlayers()) { // Spigot - well maybe sometimes you haven't turned the whitelist on just yet.
