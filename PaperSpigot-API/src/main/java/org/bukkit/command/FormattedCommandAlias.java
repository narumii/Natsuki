...
public class FormattedCommandAlias extends Command {
  ...
  private String buildCommand(String formatString, String[] args) {
    ...
    while (index != -1) {
      ...
      index++;
      int argStart = index;
      while (index < formatString.length() && inRange(((int) formatString.charAt(index)) - 48, 0,
          9)) {
      ...
      formatString =
          formatString.substring(0, start) + replacement.toString() + formatString.substring(end);
