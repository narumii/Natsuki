...
public abstract class BukkitRunnable implements Runnable {
  ...
  public synchronized BukkitTask runTaskLaterAsynchronously(Plugin plugin, long delay)
    ...
    checkState();
    return setupId(
        Bukkit.getScheduler().runTaskLaterAsynchronously(plugin, (Runnable) this, delay));
  }
   ...
   * should be taken to assure the thread-safety of asynchronous tasks.</b>
   * <p>
   * Schedules this to repeatedly run asynchronously until cancelled, starting after the specified
  ...
  public synchronized BukkitTask runTaskTimerAsynchronously(Plugin plugin, long delay, long period)
    ...
    checkState();
    return setupId(
        Bukkit.getScheduler().runTaskTimerAsynchronously(plugin, (Runnable) this, delay, period));
  }
