 ...
 * <p>
 * When the server settings dictate 'default' warnings, warnings are printed if the {@link #value()}
 * is true.
 */
...
public @interface Warning {
  ...
  enum WarningState {
    ...
    OFF,
    /**
     * Indicates each warning would default to the configured {@link Warning} annotation, or always
  ...
  /**
   * This sets if the deprecation warnings when registering events gets printed when the setting is
