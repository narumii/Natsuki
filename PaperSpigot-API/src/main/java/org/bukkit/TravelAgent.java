...
/**
 * The Travel Agent handles the creation and the research of Nether and End portals when Entities
 * try to use one.
 * <p>
 * It is used in {@link org.bukkit.event.entity.EntityPortalEvent} and in {@link
 * org.bukkit.event.player.PlayerPortalEvent} to help developers reproduce and/or modify Vanilla
 * behaviour.
 */
public interface TravelAgent {
  ...
  /**
   * Attempt to find a portal near the given location, if a portal is not found it will attempt to
   * create one.
   *
   * @param location the location where the search for a portal should begin
   * @return the location of a portal which has been found or returns the location passed to the
   ...
   * <p>
   * In the case of an Ender portal teleportation, this will (re-)create the obsidian platform and
   * clean blocks above it.
   *
   * @param location the desired location of the portal
