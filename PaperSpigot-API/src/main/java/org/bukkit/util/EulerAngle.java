...
public class EulerAngle {
  ...
  /**
   * Creates a new EulerAngle which is the result of adding the x, y, z components to this
   * EulerAngle
   *
  ...
  /**
   * Creates a new EulerAngle which is the result of subtracting the x, y, z components to this
   * EulerAngle
   *
