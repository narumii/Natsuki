...
public class Vector implements Cloneable, ConfigurationSerializable {
  ...
  /**
   * Gets the magnitude of the vector, defined as sqrt(x^2+y^2+z^2). The value of this method is not
   * cached and uses a costly square-root function, so do not repeatedly call this method to get the
   * vector's magnitude. NaN will be returned if the inner result of the sqrt() function overflows,
  ...
  public double distance(Vector o) {
    return Math.sqrt(
        NumberConversions.square(x - o.x) + NumberConversions.square(y - o.y) + NumberConversions
            .square(z - o.z));
  }
   ...
   * x1*x2+y1*y2+z1*z2. The returned value is a scalar.
   *
   * @param other The other vector
   * @return dot product
   */
  ...
  /**
   * Calculates the cross product of this vector with another without mutating the original. The
   ...
   * <p>
   * The minimum and maximum vectors given must be truly the minimum and maximum X, Y and Z
   * components.
   *
