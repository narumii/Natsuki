 ...
 * BlockVectors can be used in hash sets and hash maps. Be aware that BlockVectors are mutable, but
 * it is important that BlockVectors are never changed once put into a hash set or hash map.
 */
