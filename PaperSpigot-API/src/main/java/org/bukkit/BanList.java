...
public interface BanList {
   ...
   * @param expires date for the ban's expiration (unban), or null to imply forever
   ...
   * @return true if a {@link BanEntry} exists for the name, indicating an active ban status, false
   * otherwise
   */
