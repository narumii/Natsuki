...
public interface Damageable extends Entity {
   ...
   * @throws IllegalArgumentException Thrown if the health is {@literal < 0 or >} {@link
   * #getMaxHealth()}
   */
   ...
   * <p>
   * Note: An entity with a health bar ({@link Player}, {@link EnderDragon}, {@link Wither}, etc...}
   * will have their bar scaled accordingly.
   *
