...
public interface Bat extends Ambient {
   ...
   *
   * @return true if the bat is awake or false if it is currently hanging from a block
   */
  boolean isAwake();
   ...
   * <p>
   * This does not prevent a bat from spontaneously awaking itself, or from reattaching itself to a
   * block.
   *
