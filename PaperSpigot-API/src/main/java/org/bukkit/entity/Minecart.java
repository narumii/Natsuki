...
public interface Minecart extends Vehicle {
  ...
  /**
   * Gets the flying velocity modifier. Used for minecarts that are in mid-air. A flying minecart's
   * velocity is multiplied by this factor each tick.
   *
  ...
  /**
   * Sets the flying velocity modifier. Used for minecarts that are in mid-air. A flying minecart's
   * velocity is multiplied by this factor each tick.
   *
  ...
  /**
   * Gets the derailed velocity modifier. Used for minecarts that are on the ground, but not on
   * rails.
   * <p>
  ...
  /**
   * Sets the derailed velocity modifier. Used for minecarts that are on the ground, but not on
   * rails. A derailed minecart's velocity is multiplied by this factor each tick.
   *
  ...
  /**
   * Gets the display block for this minecart. This function will return the type AIR if none is
   * set.
   *
