...
public interface HumanEntity extends LivingEntity, AnimalTamer, Permissible, InventoryHolder {
  ...
  /**
   * If the player currently has an inventory window open, this method will set a property of that
   * window, such as the state of a progress bar.
   *
  ...
  /**
   * Gets the inventory view the player is currently viewing. If they do not have an inventory
   * window open, it returns their internal crafting view.
   *
  ...
  /**
   * Opens an inventory window with the specified inventory on the top and the player's inventory on
   * the bottom.
   *
  ...
  /**
   * Returns the ItemStack currently on your cursor, can be empty. Will always be empty if the
   * player currently has no open window.
   *
  ...
  /**
   * Sets the item to the given ItemStack, this will replace whatever the user was moving. Will
