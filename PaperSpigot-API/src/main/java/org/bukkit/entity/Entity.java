...
public interface Entity extends Metadatable, CommandSender {
  ...
  /**
   * Returns true if the entity is supported by a block. This value is a state updated by the server
   * and is not recalculated unless the entity moves.
   *
  ...
  /**
   * Teleports this entity to the given location. If this entity is riding a vehicle, it will be
   * dismounted prior to teleportation.
   *
  ...
  /**
   * Teleports this entity to the target Entity. If this entity is riding a vehicle, it will be
   * dismounted prior to teleportation.
   *
  ...
  /**
   * Gets the primary passenger of a vehicle. For vehicles that could have multiple passengers, this
   * will only return the primary passenger.
   *
   * @return an entity
   */
  Entity getPassenger();
  ...
  /**
   * Retrieve the last {@link EntityDamageEvent} inflicted on this entity. This event may have been
   * cancelled.
   *
  ...
  /**
   * Leave the current vehicle. If the entity is currently in a vehicle (and is removed from it),
  ...
  /**
   * Sets a custom name on a mob. This name will be used in death messages and can be sent to the
   * client as a nameplate over the mob.
   * <p>
  ...
  /**
   * Sets whether or not to display the mob's custom name client side. The name will be displayed
   * above the mob similarly to a player.
   * <p>
