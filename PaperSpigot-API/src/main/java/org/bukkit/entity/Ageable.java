...
public interface Ageable extends Creature {
  ...
  /**
   * Lock the age of the animal, setting this will prevent the animal from maturing or getting ready
   * for mating.
   *
   * @param lock new lock
   */
  ...
  /**
   * Set breedability of the animal, if the animal is a baby and set to breed it will instantly grow
   * up.
   *
