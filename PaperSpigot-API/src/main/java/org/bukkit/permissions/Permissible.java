...
public interface Permissible extends ServerOperator {
  ...
  /**
   * Checks if this object contains an override for the specified permission, by fully qualified
   * name
   *
   ...
   * <p>
   * If a permission override is not set on this object, the default value of the permission will be
   * returned.
   *
   * @param name Name of the permission
   ...
   * @throws IllegalArgumentException Thrown when the specified attachment isn't part of this
   * object
   */
