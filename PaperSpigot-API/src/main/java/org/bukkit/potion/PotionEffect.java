...
/**
 * Represents a potion effect, that can be added to a {@link LivingEntity}. A potion effect has a
 * duration that it will last for, an amplifier that will enhance its effects, and a {@link
 * PotionEffectType}, that represents its effect on an entity.
 */
...
public class PotionEffect implements ConfigurationSerializable {
  ...
  /**
   * Returns the amplifier of this effect. A higher amplifier means the potion effect happens more
   * often over its duration and in some cases has more effect on its target.
   *
  ...
  /**
   * Returns the duration (in ticks) that this effect will run for when applied to a {@link
   * LivingEntity}.
   *
