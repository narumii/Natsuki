...
public class Potion {
   ...
   * @deprecated In favour of using {@link #Potion(PotionType)} with {@link #extend()} and possibly
   * {@link #splash()}.
   */
  @Deprecated
  ...
  public boolean equals(Object obj) {
    ...
    return extended == other.extended && splash == other.splash && level == other.level
        && type == other.type;
  }

  /**
   * Returns a collection of {@link PotionEffect}s that this {@link Potion} would confer upon a
   * {@link LivingEntity}.
   *
