...
public interface PotionBrewer {
  ...
  /**
   * Creates a {@link PotionEffect} from the given {@link PotionEffectType}, applying duration
  ...
  /**
   * Returns a collection of {@link PotionEffect} that would be applied from a potion with the given
   * data value.
   *
