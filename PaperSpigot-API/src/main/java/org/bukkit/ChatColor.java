...
public enum ChatColor {
   ...
   * internal ChatColor.COLOR_CODE color code character. The alternate color code character will
   * only be replaced if it is immediately followed by 0-9, A-F, a-f, K-O, k-o, R or r.
   *
