 ...
 * <p>
 * This provides all the conversion functions for MetadataValue so that writing an implementation of
 * MetadataValue is as simple as implementing value() and invalidate().
 */
