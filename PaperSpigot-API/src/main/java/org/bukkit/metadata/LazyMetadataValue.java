 ...
 * plugin asks for it.
 * <p>
 * By making metadata values lazy, no computation is done by the providing plugin until absolutely
 * necessary (if ever). Additionally, LazyMetadataValue objects cache their values internally unless
 * overridden by a {@link CacheStrategy} or invalidated at the individual or plugin level. Once
...
public class LazyMetadataValue extends MetadataValueAdapter implements MetadataValue {
  ...
  public enum CacheStrategy {
    /**
     * Once the metadata value has been evaluated, do not re-evaluate the value until it is manually
     * invalidated.
     */
    ...
    /**
     * Once the metadata value has been evaluated, do not re-evaluate the value in spite of manual
     * invalidation.
     */
    CACHE_ETERNALLY
  }
