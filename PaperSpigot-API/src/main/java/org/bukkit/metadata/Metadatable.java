...
public interface Metadatable {
  ...
  /**
   * Returns a list of previously set metadata values from the implementing object's metadata
   * store.
   *
   ...
   * @param owningPlugin This plugin's metadata value will be removed. All other values will be left
   * untouched.
