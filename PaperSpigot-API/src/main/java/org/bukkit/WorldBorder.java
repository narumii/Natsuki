...
public interface WorldBorder {
   ...
   * @param seconds The time in seconds in which the border grows or shrinks from the previous size
   * to that being set.
   */
  ...
  /**
   * Sets the warning time that causes the screen to be tinted red when a contracting border will
   * reach the player within the specified time.
   *
   ...
   * specified number of blocks from the border.
   *
