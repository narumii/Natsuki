...
public class Vine extends MaterialData {
  ...
  EnumSet<BlockFace> possibleFaces = EnumSet
      .of(BlockFace.WEST, BlockFace.NORTH, BlockFace.SOUTH, BlockFace.EAST);
  ...
  /**
   * Check if the vine is attached to the specified face of an adjacent block. You can check two
   * faces at once by passing e.g. {@link BlockFace#NORTH_EAST}.
   *
