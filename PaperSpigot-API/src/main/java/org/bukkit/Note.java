...
public class Note {
  ...
  public enum Tone {
    ...
    /**
     * Returns the id of this tone. These method allows to return the sharped id of the tone. If the
     * tone couldn't be sharped it always return the not sharped id of this tone.
     *
   ...
   * Creates a new note.
   *
   * @param note Internal note id. {@link #getId()} always return this value. The value has to be in
   * the interval [0;&nbsp;24].
   */
