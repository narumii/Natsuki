...
public interface PluginManager {
   ...
   * @throws InvalidDescriptionException Thrown when the specified file contains an invalid
   * description
   ...
   * <p>
   * If a permission is already defined with the given name of the new permission, an exception will
   * be thrown.
   *
   ...
   * <p>
   * Removing a permission registration will <b>not</b> remove the permission from any {@link
   * Permissible}s that have it.
   *
  ...
  /**
   * Gets a set containing all subscribed {@link Permissible}s to the given default list, by op
   * status
   *
