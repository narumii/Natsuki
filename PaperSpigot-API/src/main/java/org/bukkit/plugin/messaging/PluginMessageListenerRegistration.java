...
public final class PluginMessageListenerRegistration {
  ...
  public boolean equals(Object obj) {
    ...
    if (this.messenger != other.messenger && (this.messenger == null || !this.messenger
        .equals(other.messenger))) {
      return false;
    }
    ...
    return this.listener == other.listener || (this.listener != null && this.listener
