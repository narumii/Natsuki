...
public interface Messenger {
  ...
  /**
   * Registers the specific plugin to the requested outgoing plugin channel, allowing it to send
   * messages through that channel to any clients.
   *
  ...
  /**
   * Unregisters the specific plugin from the requested outgoing plugin channel, no longer allowing
   * it to send messages through that channel to any clients.
   *
  ...
  /**
   * Unregisters the specific plugin from all outgoing plugin channels, no longer allowing it to
   * send any plugin messages.
   *
  ...
  /**
   * Registers the specific plugin for listening on the requested incoming plugin channel, allowing
   * it to act upon any plugin messages.
   *
   ...
   * @throws IllegalArgumentException Thrown if plugin, channel or listener is null, or the listener
   * is already registered for this channel.
   */
  ...
  /**
   * Unregisters the specific plugin's listener from listening on the requested incoming plugin
   * channel, no longer allowing it to act upon any plugin messages.
   *
  ...
  /**
   * Unregisters the specific plugin from listening on the requested incoming plugin channel, no
   * longer allowing it to act upon any plugin messages.
   *
   * @param plugin Plugin that wishes to unregister from this channel.
   * @param channel Channel to unregister.
   * @throws IllegalArgumentException Thrown if plugin or channel is null.
  ...
  /**
   * Gets a set containing all the outgoing plugin channels that the specified plugin is registered
   * to.
   *
  ...
  /**
   * Gets a set containing all the incoming plugin channels that the specified plugin is registered
   * for.
   *
   * @param plugin Plugin to retrieve channels for.
  ...
  /**
   * Gets a set containing all the incoming plugin channel registrations that the specified plugin
   * has.
   *
  ...
  /**
   * Gets a set containing all the incoming plugin channel registrations that are on the requested
   * channel.
   *
   ...
   * <p>
   * A registration is considered valid if it has not be unregistered and that the plugin is still
   * enabled.
   *
  ...
  /**
   * Checks if the specified plugin has registered to receive incoming messages through the
   * requested channel.
   *
