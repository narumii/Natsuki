...
/**
 * Represents a block. This is a live object, and only one Block may exist for any given location in
 * a world. The state of the block may change concurrently to your own handling of it; use
 * block.getState() to get a snapshot state of a block which will not be modified.
 */
public interface Block extends Metadatable {
  ...
  /**
   * Captures the current state of this block. You may then cast that state into any accepted type,
   * such as Furnace or Sign.
   * <p>
   * The returned object will never be updated, and you are not guaranteed that (for example) a sign
   * is still a sign after you capture its state.
   *
   ...
   * <p>
   * A block is considered liquid when {@link #getType()} returns {@link Material#WATER}, {@link
   * Material#STATIONARY_WATER}, {@link Material#LAVA} or {@link Material#STATIONARY_LAVA}.
   *
