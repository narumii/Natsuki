...
public abstract class ChunkGenerator {
  ...
  /**
   * Interface to biome section for chunk to be generated: initialized with default values for world
   * type and seed.
   * <p>
   ...
   * </pre>
   * Each section {@code (sectionID = (Y>>4))} that has blocks needs to be allocated space for the
   * 4096 blocks in that section:
   * <pre>
   ...
   * Notes:
   * <p>
   * This method should <b>never</b> attempt to get the Chunk at the passed coordinates, as doing so
   * may cause an infinite loop
   * <p>
   * This method should <b>never</b> modify a ChunkData after it has been returned.
   * <p>
  ...
  public interface ChunkData {
     ...
     * @param material the type to set the blocks to
     */
    void setRegion(int xMin, int yMin, int zMin, int xMax, int yMax, int zMax,
     ...
     * @param y the y location in the chunk from 0 (inclusive) - maxHeight (exclusive)
     * @param z the z location in the chunk from 0-15 inclusive
     * @return the type and data of the block or the MaterialData for air if x, y or z are outside
     * the chunk's bounds
     */
