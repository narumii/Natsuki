...
/**
 * A ConversationContext provides continuity between nodes in the prompt graph by giving the
 * developer access to the subject of the conversation and a generic map for storing values that are
 * shared between all {@link Prompt} invocations.
 */
public class ConversationContext {
   ...
   */
  public ConversationContext(Plugin plugin, Conversable forWhom,
  ...
  /**
   * Gets session data shared between all {@link Prompt} invocations. Use this as a way to pass data
   * through each Prompt as the conversation develops.
   *
  ...
  /**
   * Sets session data shared between all {@link Prompt} invocations. Use this as a way to pass data
   * through each prompt as the conversation develops.
   *
   * @param key The session data key.
