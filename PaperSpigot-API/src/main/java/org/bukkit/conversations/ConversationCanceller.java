...
/**
 * A ConversationCanceller is a class that cancels an active {@link Conversation}. A Conversation
 * can have more than one ConversationCanceller.
 */
public interface ConversationCanceller extends Cloneable {
  ...
  /**
   * Allows the {@link ConversationFactory} to duplicate this ConversationCanceller when creating a
