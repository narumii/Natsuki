...
public class ActivationRange {
  ...
  /**
   * Initializes an entities type on construction to specify what group this entity is in for
   * activation ranges.
   *
   * @return group id
   */
  ...
  public static void activateEntities(World world) {
    ...
    for (Entity player : (List<Entity>) (List) world.players) {
      ...
      int i = (int) Math.floor(maxBB.a / 16.0D);
      int j = (int) Math.floor(maxBB.d / 16.0D);
      int k = (int) Math.floor(maxBB.c / 16.0D);
      int l = (int) Math.floor(maxBB.f / 16.0D);
  ...
  public static boolean checkEntityImmunities(Entity entity) {
    ...
    if (entity instanceof EntityLiving) {
      ...
      if (entity instanceof EntityVillager && ((EntityVillager) entity)
          .cm() /* Getter for first boolean */) {
        return true;
      }
  ...
  public static boolean checkIfActive(Entity entity) {
    ...
    if (!entity.isAddedToChunk() || entity instanceof EntityFireworks
        || entity.loadChunks) { // PaperSpigot
      SpigotTimings.checkIfActiveTimer.stopTiming();
      return true;
    }

    boolean isActive =
        entity.activatedTick >= MinecraftServer.currentTick || entity.defaultActivationState;
    ...
    } else if (!entity.defaultActivationState && entity.ticksLived % 4 == 0
        && !checkEntityImmunities(entity)) {
      isActive = false;
    }
    int x = (int) Math.floor(entity.locX);
    int z = (int) Math.floor(entity.locZ);
