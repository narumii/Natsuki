...
public class SpigotWorldConfig {
  ...
  private void activationRange() {
    ...
    log("Entity Activation Range: An " + animalActivationRange + " / Mo " + monsterActivationRange
  ...
  private void trackingRange() {
    ...
    log("Entity Tracking Range: Pl " + playerTrackingRange + " / An " + animalTrackingRange
        + " / Mo " + monsterTrackingRange + " / Mi " + miscTrackingRange + " / Other "
        + otherTrackingRange);
  }
  ...
  private void hoppers() {
    ...
    log("Hopper Transfer: " + hopperTransfer + " Hopper Check: " + hopperCheck + " Hopper Amount: "
        + hopperAmount);
  }
  ...
  private void maxTickTimes() {
    ...
    log("Tile Max Tick Time: " + tileMaxTickTime + "ms Entity max Tick Time: " + entityMaxTickTime
        + "ms");
  }
}
