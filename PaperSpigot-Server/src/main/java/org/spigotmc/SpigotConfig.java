...
import pw.narumi.command.AddressCommand;
import pw.narumi.command.ConnectionsCommand;
import pw.narumi.command.NatsukiCommand;
import pw.narumi.command.NatsukiReloadCommand;
...
public class SpigotConfig {
  ...
  public static void init(File configFile) {
    ...
    try {
      ...
      Bukkit.getLogger()
          .log(Level.SEVERE, "Could not load spigot.yml, please correct your syntax errors", ex);
  ...
  public static void registerCommands() {
    MinecraftServer.getServer().server.getCommandMap()
        .register("Natsuki", "Natsuki", new NatsukiCommand());

    MinecraftServer.getServer().server.getCommandMap()
        .register("Address", "Natsuki", new AddressCommand());

    MinecraftServer.getServer().server.getCommandMap()
        .register("NatsukiReload", "Natsuki", new NatsukiReloadCommand());

    MinecraftServer.getServer().server.getCommandMap()
        .register("Connections", "Natsuki", new ConnectionsCommand());
  ...
  private static void messages() {
    ...
    whitelistMessage = transform(
        getString("messages.whitelist", "You are not whitelisted on this server!"));
  ...
  private static void debug() {
    ...
    if (debug && !LogManager.getRootLogger().isTraceEnabled()) {
      ...
      conf.getLoggerConfig(LogManager.ROOT_LOGGER_NAME)
          .setLevel(org.apache.logging.log4j.Level.ALL);
