...
public class CraftChunk implements Chunk {
  ...
  public BlockState[] getTileEntities() {
    ...
    for (Object obj : chunk.tileEntities.keySet().toArray()) {
      ...
      entities[index++] = worldServer.getWorld()
  ...
  public ChunkSnapshot getChunkSnapshot(boolean includeMaxBlockY, boolean includeBiome,
    ...
    return new CraftChunkSnapshot(getX(), getZ(), world.getName(), world.getFullTime(),
        sectionBlockIDs, sectionBlockData, sectionSkyLights, sectionEmitLights, sectionEmpty, hmap,
  ...
  public static ChunkSnapshot getEmptyChunkSnapshot(int x, int z, CraftWorld world,
    ...
    return new CraftChunkSnapshot(x, z, world.getName(), world.getFullTime(), blockIDs, blockData,
        skyLight, emitLight, empty, new int[256], biome, biomeTemp, biomeRain);
  }
