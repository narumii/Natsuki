...
public class LongObjectHashMap<V> implements Cloneable, Serializable {
  ...
  /**
   * Returns a Set of Entry objects for the HashMap. This is not how the internal implementation is
   * laid out so this constructs the entire Set when called. For this reason it should be avoided if
   * at all possible.
   *
