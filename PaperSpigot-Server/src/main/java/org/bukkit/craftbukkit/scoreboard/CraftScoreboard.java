...
public final class CraftScoreboard implements org.bukkit.scoreboard.Scoreboard {
  ...
  public CraftObjective registerNewObjective(String name, String criteria)
    ...
    Validate.isTrue(name.length() <= 16,
        "The name '" + name + "' is longer than the limit of 16 characters");
    Validate.isTrue(board.getObjective(name) == null,
  ...
  public ImmutableSet<Objective> getObjectives() {
    return ImmutableSet.copyOf(Iterables
        .transform(this.board.getObjectives(), new Function<ScoreboardObjective, Objective>() {
  ...
  public Objective getObjective(DisplaySlot slot) throws IllegalArgumentException {
    ...
    ScoreboardObjective objective = board
        .getObjectiveForSlot(CraftScoreboardTranslations.fromBukkitSlot(slot));
    if (objective == null) {
      return null;
    }
    return new CraftObjective(this, objective);
  ...
  public ImmutableSet<Team> getTeams() {
    return ImmutableSet
        .copyOf(Iterables.transform(this.board.getTeams(), new Function<ScoreboardTeam, Team>() {
  ...
  public Team registerNewTeam(String name) throws IllegalArgumentException {
    ...
    Validate.isTrue(name.length() <= 16,
        "Team name '" + name + "' is longer than the limit of 16 characters");
