...
public class CraftBlockProjectileSource implements BlockProjectileSource {
  ...
  public Block getBlock() {
    return dispenserBlock.getWorld().getWorld()
        .getBlockAt(dispenserBlock.getPosition().getX(), dispenserBlock.getPosition().getY(),
            dispenserBlock.getPosition().getZ());
  }
  ...
  public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
    ...
    SourceBlock isourceblock = new SourceBlock(dispenserBlock.getWorld(),
        dispenserBlock.getPosition());
    ...
    if (Snowball.class.isAssignableFrom(projectile)) {
      ...
      launch = new EntityThrownExpBottle(world, iposition.getX(), iposition.getY(),
          iposition.getZ());
    ...
    if (launch instanceof IProjectile) {
      ...
      // Copied from DispenseBehaviorProjectile
      ((IProjectile) launch)
          .shoot(enumdirection.getAdjacentX(), (float) enumdirection.getAdjacentY() + 0.1F,
