...
class CraftMetaPotion extends CraftMetaItem implements PotionMeta {
  ...
  static final ItemMetaKey POTION_EFFECTS = new ItemMetaKey("CustomPotionEffects",
      "custom-effects");
  ...
  CraftMetaPotion(Map<String, Object> map) {
    ...
    Iterable<?> rawEffectList = SerializableMeta
        .getObject(Iterable.class, map, POTION_EFFECTS.BUKKIT, true);
  ...
  public boolean equalsCommon(CraftMetaItem meta) {
    ...
    if (meta instanceof CraftMetaPotion) {
      ...
      return (this.hasCustomEffects() ? that.hasCustomEffects() && this.customEffects
          .equals(that.customEffects) : !that.hasCustomEffects());
    }
    return true;
  }
