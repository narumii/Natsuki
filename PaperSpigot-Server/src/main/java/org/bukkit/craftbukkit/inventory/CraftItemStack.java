...
public final class CraftItemStack extends ItemStack {
  ...
  public static net.minecraft.server.ItemStack asNMSCopy(ItemStack original) {
    ...
    net.minecraft.server.ItemStack stack = new net.minecraft.server.ItemStack(item,
  ...
  public static net.minecraft.server.ItemStack copyNMSStack(net.minecraft.server.ItemStack original,
      int amount) {
  ...
  public static ItemStack asBukkitCopy(net.minecraft.server.ItemStack original) {
    ...
    ItemStack stack = new ItemStack(CraftMagicNumbers.getMaterial(original.getItem()),
        original.count, (short) original.getData());
  ...
  public static ItemMeta getItemMeta(net.minecraft.server.ItemStack item) {
    ...
    switch (getType(item)) {
      ...
      case FLOWER_POT_ITEM:
        return new CraftMetaBlockState(item.getTag(),
  ...
  static Material getType(net.minecraft.server.ItemStack item) {
    Material material = Material
        .getMaterial(item == null ? 0 : CraftMagicNumbers.getId(item.getItem()));
  ...
  public boolean isSimilar(ItemStack stack) {
    ...
    return hasItemMeta() ? that.hasItemMeta() && handle.getTag().equals(that.handle.getTag())
        : !that.hasItemMeta();
  }
