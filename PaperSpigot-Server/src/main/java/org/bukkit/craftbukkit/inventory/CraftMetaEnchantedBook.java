...
class CraftMetaEnchantedBook extends CraftMetaItem implements EnchantmentStorageMeta {
  ...
  static final ItemMetaKey STORED_ENCHANTMENTS = new ItemMetaKey("StoredEnchantments",
      "stored-enchants");
  ...
  boolean equalsCommon(CraftMetaItem meta) {
    ...
    if (meta instanceof CraftMetaEnchantedBook) {
      ...
      return (hasStoredEnchants() ? that.hasStoredEnchants() && this.enchantments
          .equals(that.enchantments) : !that.hasStoredEnchants());
    }
    return true;
  }
  ...
  boolean notUncommon(CraftMetaItem meta) {
    return super.notUncommon(meta) && (meta instanceof CraftMetaEnchantedBook
        || isEnchantedEmpty());
  }
