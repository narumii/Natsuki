...
public class CraftInventoryPlayer extends CraftInventory implements
  ...
  public void setItem(int index, ItemStack item) {
    ...
    player.playerConnection.sendPacket(
        new PacketPlayOutSetSlot(player.defaultContainer.windowId, index,
  ...
  public void setHeldItemSlot(int slot) {
    ...
    ((CraftPlayer) this.getHolder()).getHandle().playerConnection
        .sendPacket(new PacketPlayOutHeldItemSlot(slot));
  }
