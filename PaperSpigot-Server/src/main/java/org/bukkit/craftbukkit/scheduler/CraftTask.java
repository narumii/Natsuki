...
public class CraftTask implements BukkitTask, Runnable { // Spigot
  ...
  /**
   * -1 means no repeating <br> -2 means cancel <br> -3 means processing for Future <br> -4 means
   * done for Future <br> Never 0 <br> >0 means number of ticks to wait between each execution
   */
