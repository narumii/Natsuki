...
/**
 * An EntityMetadataStore stores metadata values for all {@link Entity} classes an their
 * descendants.
 */
public class EntityMetadataStore extends MetadataStoreBase<Entity> implements
