...
public class BlockMetadataStore extends MetadataStoreBase<Block> implements MetadataStore<Block> {
  ...
  /**
   * Generates a unique metadata key for a {@link Block} object based on its coordinates in the
   * world.
   *
  ...
  /**
   * Retrieves the metadata for a {@link Block}, ensuring the block being asked for actually belongs
  ...
  /**
   * Tests to see if a metadata value has been added to a {@link Block}, ensuring the block being
   * interrogated belongs to this BlockMetadataStore's owning world.
   *
  ...
  /**
   * Removes metadata from from a {@link Block} belonging to a given {@link Plugin}, ensuring the
   * block being deleted from belongs to this BlockMetadataStore's owning world.
   *
  ...
  /**
   * Sets or overwrites a metadata value on a {@link Block} from a given {@link Plugin}, ensuring
   * the target block belongs to this BlockMetadataStore's owning world.
   *
