...
/**
 * Represents a static, thread-safe snapshot of chunk of blocks Purpose is to allow clean, efficient
 * copy of a chunk data to be made, and then handed off for processing in another thread (e.g. map
 * rendering)
 */
public class CraftChunkSnapshot implements ChunkSnapshot {
  ...
  CraftChunkSnapshot(int x, int z, String wname, long wtime, short[][] sectionBlockIDs,
      byte[][] sectionBlockData, byte[][] sectionSkyLights, byte[][] sectionEmitLights,
      boolean[] sectionEmpty, int[] hmap, BiomeBase[] biome, double[] biomeTemp,
      double[] biomeRain) {
    this.x = x;
    this.z = z;
