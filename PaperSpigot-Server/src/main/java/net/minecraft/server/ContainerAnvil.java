...
public class ContainerAnvil extends Container {
  ...
  public ContainerAnvil(PlayerInventory playerinventory, final World world,
      final BlockPosition blockposition, EntityHuman entityhuman) {
    ...
    this.a(new Slot(this.g, 2, 134, 47) {
      ...
      public boolean isAllowed(EntityHuman entityhuman) {
        return (entityhuman.abilities.canInstantlyBuild
            || entityhuman.expLevel >= ContainerAnvil.this.a) && ContainerAnvil.this.a > 0 && this
            .hasItem();
      }
        ...
        if (!entityhuman.abilities.canInstantlyBuild && !world.isClientSide
          ...
          if (i > 2) {
            ...
            world.setTypeAndData(blockposition,
                iblockdata.set(BlockAnvil.DAMAGE, Integer.valueOf(i)), 2);
    ...
    if (itemstack == null) {
      ...
      if (itemstack2 != null) {
        flag7 = itemstack2.getItem() == Items.ENCHANTED_BOOK
            && Items.ENCHANTED_BOOK.h(itemstack2).size() > 0;
        int l;
        int i1;
        ...
        if (itemstack1.e() && itemstack1.getItem().a(itemstack, itemstack2)) {
          ...
          while (iterator.hasNext()) {
            ...
            if (enchantment != null) {
              j1 = map.containsKey(Integer.valueOf(i1)) ? ((Integer) map.get(Integer.valueOf(i1)))
                  .intValue() : 0;
              ...
              if (this.m.abilities.canInstantlyBuild
  ...
  public boolean a(EntityHuman entityhuman) {
    ...
    return this.i.getType(this.j).getBlock() == Blocks.ANVIL && entityhuman
        .e((double) this.j.getX() + 0.5D, (double) this.j.getY() + 0.5D,
