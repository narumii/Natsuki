...
public class BlockSkull extends BlockContainer {
  ...
  protected BlockSkull() {
    ...
    this.j(this.blockStateList.getBlockData().set(BlockSkull.FACING, EnumDirection.NORTH)
  ...
  public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
    switch (BlockSkull.SyntheticClass_1.a[iblockaccess.getType(blockposition).get(BlockSkull.FACING)
        .ordinal()]) {
      case 1:
      default:
        this.a(0.25F, 0.0F, 0.25F, 0.75F, 0.5F, 0.75F);
  ...
  public IBlockData getPlacedState(World world, BlockPosition blockposition,
    ...
    return this.getBlockData().set(BlockSkull.FACING, entityliving.getDirection())
        .set(BlockSkull.NODROP, Boolean.valueOf(false));
  }
      ...
      if (false) {
        ...
        if (tileentity instanceof TileEntitySkull) {
          ...
          ItemStack itemstack = new ItemStack(Items.SKULL, 1,
              this.getDropData(world, blockposition));
  ...
  public boolean b(World world, BlockPosition blockposition, ItemStack itemstack) {
    return (itemstack.getData() == 1 && blockposition.getY() >= 2
        && world.getDifficulty() != EnumDifficulty.PEACEFUL && !world.isClientSide)
        && this.l().a(world, blockposition) != null;
  }
  ...
  public void a(World world, BlockPosition blockposition, TileEntitySkull tileentityskull) {
    ...
    if (tileentityskull.getSkullType() == 1 && blockposition.getY() >= 2
      ...
      ShapeDetector.ShapeDetectorCollection shapedetector_shapedetectorcollection = shapedetector
      ...
      if (shapedetector_shapedetectorcollection != null) {
        ...
        for (i = 0; i < shapedetector.c(); ++i) {
          for (int j = 0; j < shapedetector.b(); ++j) {
            ShapeDetectorBlock shapedetectorblock1 = shapedetector_shapedetectorcollection
                .a(i, j, 0);
        ...
        BlockPosition blockposition1 = shapedetector_shapedetectorcollection.a(1, 0, 0)
            .getPosition();
        EntityWither entitywither = new EntityWither(world);
        BlockPosition blockposition2 = shapedetector_shapedetectorcollection.a(1, 2, 0)
            .getPosition();

        entitywither.setPositionRotation((double) blockposition2.getX() + 0.5D,
            (double) blockposition2.getY() + 0.55D, (double) blockposition2.getZ() + 0.5D,
            shapedetector_shapedetectorcollection.b().k() == EnumDirection.EnumAxis.X ? 0.0F
                : 90.0F, 0.0F);
        entitywither.aI =
            shapedetector_shapedetectorcollection.b().k() == EnumDirection.EnumAxis.X ? 0.0F
                : 90.0F;
        ...
        if (world.addEntity(entitywither, SpawnReason.BUILD_WITHER)) {
          ...
          for (k = 0; k < 120; ++k) {
            world.addParticle(EnumParticle.SNOWBALL,
                ...
                (double) blockposition1.getZ() + world.random.nextDouble(), 0.0D, 0.0D, 0.0D);
          }

          for (k = 0; k < shapedetector.c(); ++k) {
            for (int l = 0; l < shapedetector.b(); ++l) {
              ShapeDetectorBlock shapedetectorblock2 = shapedetector_shapedetectorcollection
                  .a(k, l, 0);
