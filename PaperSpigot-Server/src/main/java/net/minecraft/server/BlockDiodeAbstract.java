...
public abstract class BlockDiodeAbstract extends BlockDirectional {
  ...
  public int a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata,
    ...
    return !this.l(iblockdata) ? 0
        : (iblockdata.get(BlockDiodeAbstract.FACING) == enumdirection ? this
            .a(iblockaccess, blockposition, iblockdata) : 0);
  }
  ...
  protected int c(IBlockAccess iblockaccess, BlockPosition blockposition,
    ...
    return this.c(block) ? (block == Blocks.REDSTONE_WIRE ? iblockdata.get(BlockRedstoneWire.POWER)
        .intValue() : iblockaccess.getBlockPower(blockposition, enumdirection)) : 0;
  }
  ...
  public IBlockData getPlacedState(World world, BlockPosition blockposition,
    ...
    return this.getBlockData()
        .set(BlockDiodeAbstract.FACING, entityliving.getDirection().opposite());
  }
  ...
  public boolean e(Block block) {
    return block == this.e(this.getBlockData()).getBlock() || block == this.k(this.getBlockData())
        .getBlock();
  }
