...
public class PathfinderGoalTargetNearestPlayer extends PathfinderGoal {
  ...
  public PathfinderGoalTargetNearestPlayer(EntityInsentient entityinsentient) {
    ...
    if (entityinsentient instanceof EntityCreature) {
      PathfinderGoalTargetNearestPlayer.a
    ...
    this.c = new Predicate() {
      public boolean a(Entity entity) {
        if (!(entity instanceof EntityHuman)) {
          ...
          return !((double) entity.g(PathfinderGoalTargetNearestPlayer.this.b) > d0)
              && PathfinderGoalTarget
              .a(PathfinderGoalTargetNearestPlayer.this.b, (EntityLiving) entity, false, true);
        }
      }
  ...
  public boolean a() {
    double d0 = this.f();
    List list = this.b.world
        .a(EntityHuman.class, this.b.getBoundingBox().grow(d0, 4.0D, d0), this.c);
  ...
  protected double f() {
    AttributeInstance attributeinstance = this.b
