...
public class ItemArmor extends Item {
  ...
  private static final IDispenseBehavior l = new DispenseBehaviorItem() {
    protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
      ...
      List list = isourceblock.getWorld().a(EntityLiving.class, axisalignedbb, Predicates
          .and(IEntitySelector.d, new IEntitySelector.EntitySelectorEquipable(itemstack)));
  ...
  public boolean d_(ItemStack itemstack) {
    return this.m == EnumArmorMaterial.LEATHER && (itemstack.hasTag() && (
        itemstack.getTag().hasKeyOfType("display", 10) && itemstack.getTag().getCompound("display")
            .hasKeyOfType("color", 3)));
  }
  ...
  public enum EnumArmorMaterial {
    ...
    LEATHER("leather", 5, new int[]{1, 3, 2, 1}, 15), CHAIN("chainmail", 15, new int[]{2, 5, 4, 1},
        12), IRON("iron", 15, new int[]{2, 6, 5, 2}, 9), GOLD("gold", 7, new int[]{2, 5, 3, 1},
        25), DIAMOND("diamond", 33, new int[]{3, 8, 6, 3}, 10);
