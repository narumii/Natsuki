...
public class ContainerPlayer extends Container {
  ...
  public ContainerPlayer(final PlayerInventory playerinventory, boolean flag,
    ...
    this.craftInventory = new InventoryCrafting(this, 2, 2,
        playerinventory.player); // CraftBukkit - pass player
    this.craftInventory.resultInventory = this.resultInventory; // CraftBukkit - let InventoryCrafting know about its result slot
    this.player = playerinventory; // CraftBukkit - save player
    this.a(new SlotResult(playerinventory.player, this.craftInventory, this.resultInventory, 0, 144,
        36));
      ...
      this.a(new Slot(playerinventory, playerinventory.getSize() - 1 - ii, 8, 8 + ii * 18) {
        ...
        public boolean isAllowed(ItemStack itemstack) {
          return itemstack != null && (itemstack.getItem() instanceof ItemArmor ?
              ((ItemArmor) itemstack.getItem()).b == i
  ...
  public void a(IInventory iinventory) {
    ...
    EntityPlayer player = (EntityPlayer) super.listeners
        .get(0); // TODO: Is this _always_ correct? Seems like it.
    player.playerConnection
        .sendPacket(new PacketPlayOutSetSlot(player.activeContainer.windowId, 0, craftResult));
    // CraftBukkit end
  }
  ...
  public ItemStack b(EntityHuman entityhuman, int i) {
    ...
    if (slot != null && slot.hasItem()) {
      ...
      } else if (itemstack.getItem() instanceof ItemArmor && !this.c
          .get(5 + ((ItemArmor) itemstack.getItem()).b).hasItem()) {
