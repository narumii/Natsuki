...
public class BlockChest extends BlockContainer {
  ...
  public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    EnumDirection enumdirection = EnumDirection
        .fromType2(MathHelper.floor((double) (entityliving.yaw * 4.0F / 360.0F) + 0.5D) & 3)
        .opposite();
      ...
      if (block != this && block1 != this) {
        ...
        if (block2 == this || block3 == this) {
          BlockPosition blockposition1 =
              block2 == this ? blockposition.west() : blockposition.east();
        ...
        BlockPosition blockposition2 =
            block == this ? blockposition.north() : blockposition.south();
            ...
            if (tileentity1 instanceof TileEntityChest) {
              if (enumdirection != EnumDirection.WEST && enumdirection != EnumDirection.NORTH) {
                ...
                object = new InventoryLargeChest("container.chestDouble",
                    (TileEntityChest) tileentity1, (ITileInventory) object);
              }
            }
          }
        }
  ...
  public int b(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata,
      EnumDirection enumdirection) {
    return enumdirection == EnumDirection.UP ? this
        .a(iblockaccess, blockposition, iblockdata, enumdirection) : 0;
  }
  ...
  private boolean p(World world, BlockPosition blockposition) {
    ...
    Iterator iterator = world.a(EntityOcelot.class,
        new AxisAlignedBB((double) blockposition.getX(), (double) (blockposition.getY() + 1),
            ...
            (double) (blockposition.getY() + 2), (double) (blockposition.getZ() + 1))).iterator();
