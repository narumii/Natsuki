  ...
  static void b() {
    BlockDispenser.REGISTRY.a(Items.ARROW, new DispenseBehaviorProjectile() {
      protected IProjectile a(World world, IPosition iposition) {
        EntityArrow entityarrow = new EntityArrow(world, iposition.getX(), iposition.getY(),
            iposition.getZ());
    ...
    BlockDispenser.REGISTRY.a(Items.EXPERIENCE_BOTTLE, new DispenseBehaviorProjectile() {
      protected IProjectile a(World world, IPosition iposition) {
        return new EntityThrownExpBottle(world, iposition.getX(), iposition.getY(),
            iposition.getZ());
      }
    ...
    BlockDispenser.REGISTRY.a(Items.SPAWN_EGG, new DispenseBehaviorItem() {
      public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        Entity entity = ItemMonsterEgg
            .spawnCreature(isourceblock.getWorld(), itemstack.getData(), event.getVelocity().getX(),
                event.getVelocity().getY(), event.getVelocity().getZ(),
    ...
    BlockDispenser.REGISTRY.a(Items.BOAT, new DispenseBehaviorItem() {
      ...
      public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        if (Material.WATER.equals(material)) {
          ...
          if (!Material.AIR.equals(material) || !Material.WATER
              .equals(world.getType(blockposition.down()).getBlock().getMaterial())) {
        ...
        EntityBoat entityboat = new EntityBoat(world, event.getVelocity().getX(),
            event.getVelocity().getY(), event.getVelocity().getZ());
        // CraftBukkit end
    ...
    DispenseBehaviorItem dispensebehavioritem = new DispenseBehaviorItem() {
      ...
      public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        if (world.isEmpty(blockposition) || !world.getType(blockposition).getBlock().getMaterial()
            .isBuildable()) {
          org.bukkit.block.Block block = world.getWorld()
              .getBlockAt(isourceblock.getBlockPosition().getX(),
                  isourceblock.getBlockPosition().getY(), isourceblock.getBlockPosition().getZ());
        ...
        if (itembucket.a(isourceblock.getWorld(), blockposition)) {
          ...
          if (--itemstack.count == 0) {
            ...
            itemstack.count = 1;
              ...
              ((TileEntityDispenser) isourceblock.getTileEntity()).addItem(new ItemStack(item))
                  < 0) {
    ...
    BlockDispenser.REGISTRY.a(Items.BUCKET, new DispenseBehaviorItem() {
      ...
      public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
        ...
        BlockDispenseEvent event = new BlockDispenseEvent(bukkitBlock, craftItem.clone(),
            new org.bukkit.util.Vector(blockposition.getX(), blockposition.getY(),
                blockposition.getZ()));
        if (!BlockDispenser.eventFired) {
          world.getServer().getPluginManager().callEvent(event);
        }
