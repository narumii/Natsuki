  ...
  public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world,
    ...
    if (!entityhuman.a(blockposition, enumdirection, itemstack)) {
      ...
      if (world.getType(blockposition).getBlock().getMaterial() == Material.AIR) {
        ...
        CraftBlockState blockState = CraftBlockState
            .getBlockState(world, blockposition.getX(), blockposition.getY(), blockposition.getZ());
        // CraftBukkit end
        ...
        // CraftBukkit start
        org.bukkit.event.block.BlockPlaceEvent placeEvent = CraftEventFactory
            .callBlockPlaceEvent(world, entityhuman, blockState, clicked.getX(), clicked.getY(),
                clicked.getZ());
