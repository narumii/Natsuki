...
public class EntityWitherSkull extends EntityFireball {
  ...
  public EntityWitherSkull(World world, EntityLiving entityliving, double d0, double d1,
      double d2) {
    ...
    if (!this.world.isClientSide) {
      if (movingobjectposition.entity != null) {
        ...
        if (this.shooter != null) {
          didDamage = movingobjectposition.entity
              .damageEntity(DamageSource.projectile(this, shooter), 8.0F);
          if (didDamage) {
