...
public class EntityItem extends Entity {
  ...
  public void t_() {
    if (this.getItemStack() == null) {
      ...
      this.noclip = this
          .j(this.locX, (this.getBoundingBox().b + this.getBoundingBox().e) / 2.0D, this.locZ);
      ...
      if (this.onGround) {
        f = this.world.getType(new BlockPosition(MathHelper.floor(this.locX),
      ...
      if (!this.world.isClientSide && this.age >= world.spigotConfig.itemDespawnRate) { // Spigot
        ...
        if (org.bukkit.craftbukkit.event.CraftEventFactory.callItemDespawnEvent(this)
            .isCancelled()) {
          this.age = 0;
          return;
        }
  ...
  private void w() {
    ...
    Iterator iterator = this.world
        .a(EntityItem.class, this.getBoundingBox().grow(radius, radius, radius)).iterator();
    // Spigot end
  ...
  public void d(EntityHuman entityhuman) {
    if (!this.world.isClientSide) {
      ...
      if (this.pickupDelay == 0 && (this.g == null || 6000 - this.age <= 200 || this.g
          .equals(entityhuman.getName())) && entityhuman.inventory.pickup(itemstack)) {
  ...
  public String getName() {
    return this.hasCustomName() ? this.getCustomName()
        : LocaleI18n.get("item." + this.getItemStack().a());
  }
