...
public class NBTTagCompound extends NBTBase {
  ...
  //Zmieniono z private na public :D
  public Map<String, NBTBase> map = Maps.newHashMap();
  ...
  public NBTTagCompound getCompound(String var1) {
    try {
      return !this.hasKeyOfType(var1, 10) ? new NBTTagCompound()
          : (NBTTagCompound) this.map.get(var1);
    } catch (ClassCastException var3) {
  ...
  public String toString() {
    ...
    Entry var3;
    for (Iterator var2 = this.map.entrySet().iterator(); var2.hasNext();
