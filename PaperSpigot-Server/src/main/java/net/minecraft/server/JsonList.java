...
public class JsonList<K, V extends JsonListEntry<K>> {
  ...
  public JsonList(File file) {
    ...
    gsonbuilder.registerTypeHierarchyAdapter(JsonListEntry.class,
        new JsonList.JsonListEntrySerializer(null));
  ...
  public void load() throws FileNotFoundException {
    ...
    try {
      ...
      org.bukkit.Bukkit.getLogger()
          .log(java.util.logging.Level.INFO, "Unable to find file {0}, creating it.", this.c);
    ...
    if (collection != null) {
      ...
      while (iterator.hasNext()) {
        ...
        if (jsonlistentry.getKey() != null) {
          this.d.put(this.a((K) jsonlistentry.getKey()),
              (V) jsonlistentry); // CraftBukkit - fix decompile error
        }
      }
    }
  ...
  class JsonListEntrySerializer implements JsonDeserializer<JsonListEntry<K>>,
      JsonSerializer<JsonListEntry<K>> {
