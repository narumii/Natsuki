...
public class TileEntitySign extends TileEntity {
  ...
  public void a(NBTTagCompound nbttagcompound) {
    ...
    boolean oldSign = Boolean.getBoolean("convertLegacySigns") && !nbttagcompound
        .getBoolean("Bukkit.isConverted");
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      try {
        ...
        try {
          this.lines[i] = ChatComponentUtils
              .filterForDisplay(icommandlistener, ichatbasecomponent, null);
      ...
      if (chatmodifier != null && chatmodifier.h() != null) {
        ...
        if (chatclickable.a() == ChatClickable.EnumClickAction.RUN_COMMAND) {
          ...
          CommandBlockListenerAbstract
              .executeCommand(entityhuman, entityhuman.getBukkitEntity(), chatclickable.b());
          // CraftBukkit end
        }
      }
    }
