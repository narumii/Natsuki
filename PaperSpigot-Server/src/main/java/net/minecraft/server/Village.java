...
public class Village {
  ...
  public VillageDoor e(BlockPosition blockposition) {
    if (this.d.i(blockposition) > (double) (this.e * this.e)) {
      ...
      } while (villagedoor.d().getX() != blockposition.getX()
          || villagedoor.d().getZ() != blockposition.getZ()
  ...
  private void n() {
    ...
    if (i == 0) {
      ...
      for (Iterator iterator = this.b.iterator(); iterator.hasNext();
    ...
    for (int i = 0; i < nbttaglist.size(); ++i) {
      ...
      VillageDoor villagedoor = new VillageDoor(
          new BlockPosition(nbttagcompound1.getInt("X"), nbttagcompound1.getInt("Y"),
              nbttagcompound1.getInt("Z")), nbttagcompound1.getInt("IDX"),
          nbttagcompound1.getInt("IDZ"), nbttagcompound1.getInt("TS"));
