...
public class BlockTripwireHook extends Block {
  ...
  public boolean canPlace(World world, BlockPosition blockposition, EnumDirection enumdirection) {
    return enumdirection.k().c() && world.getType(blockposition.shift(enumdirection.opposite()))
        .getBlock().isOccluding();
  }
  ...
  public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (block != this) {
      if (this.e(world, blockposition, iblockdata)) {
        ...
        if (!world.getType(blockposition.shift(enumdirection.opposite())).getBlock()
            .isOccluding()) {
  ...
  public void a(World world, BlockPosition blockposition, IBlockData iblockdata, boolean flag,
      boolean flag1, int i, IBlockData iblockdata1) {
    EnumDirection enumdirection = iblockdata.get(BlockTripwireHook.FACING);
    ...
    flag5 &= j > 1;
    flag6 &= flag5;
    IBlockData iblockdata3 = this.getBlockData()
        .set(BlockTripwireHook.ATTACHED, Boolean.valueOf(flag5))
    ...
    if (j > 0) {
      ...
      world
          .setTypeAndData(blockposition1, iblockdata3.set(BlockTripwireHook.FACING, enumdirection1),
              3);
    ...
    if (!flag) {
      world.setTypeAndData(blockposition, iblockdata3.set(BlockTripwireHook.FACING, enumdirection),
          3);
      if (flag1) {
  ...
  private void a(World world, BlockPosition blockposition, boolean flag, boolean flag1,
      boolean flag2, boolean flag3) {
    if (flag1 && !flag3) {
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.4F, 0.6F);
    } else if (!flag1 && flag3) {
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.4F, 0.5F);
    } else if (flag && !flag2) {
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.4F, 0.7F);
    } else if (!flag && flag2) {
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.1D,
          (double) blockposition.getZ() + 0.5D, "random.bowhit", 0.4F,
  ...
  public void remove(World world, BlockPosition blockposition, IBlockData iblockdata) {
    ...
    if (flag1) {
      world.applyPhysics(blockposition, this);
      world.applyPhysics(blockposition.shift(iblockdata.get(BlockTripwireHook.FACING).opposite()),
          this);
    }
