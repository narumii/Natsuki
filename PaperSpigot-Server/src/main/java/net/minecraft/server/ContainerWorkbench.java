...
public class ContainerWorkbench extends Container {
  ...
  public ContainerWorkbench(PlayerInventory playerinventory, World world,
    ...
    this.a(new SlotResult(playerinventory.player, this.craftInventory, this.resultInventory, 0, 124,
        35));
  ...
  public boolean a(EntityHuman entityhuman) {
    ...
    return this.g.getType(this.h).getBlock() == Blocks.CRAFTING_TABLE && entityhuman
        .e((double) this.h.getX() + 0.5D, (double) this.h.getY() + 0.5D,
