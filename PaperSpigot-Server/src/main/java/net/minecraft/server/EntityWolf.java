...
public class EntityWolf extends EntityTameableAnimal {
  ...
  public EntityWolf(World world) {
    ...
    this.targetSelector
        .a(5, new PathfinderGoalNearestAttackableTarget(this, EntitySkeleton.class, false));
    this.setTamed(false);
  }
  ...
  @Override
  public void setGoalTarget(EntityLiving entityliving,
      org.bukkit.event.entity.EntityTargetEvent.TargetReason reason, boolean fire) {
  ...
  protected String z() {
    ...
    return this.isAngry() ? "mob.wolf.growl" : (this.random.nextInt(3) == 0 ? (
    ...
    if (this.U()) {
      ...
      if (this.bs > 0.4F) {
        ...
        for (int j = 0; j < i; ++j) {
          ...
          this.world
              .addParticle(EnumParticle.WATER_SPLASH, this.locX + (double) f1, (double) (f + 0.8F),
  ...
  public boolean r(Entity entity) {
    boolean flag = entity.damageEntity(DamageSource.mobAttack(this),
        (float) ((int) this.getAttributeInstance(GenericAttributes.ATTACK_DAMAGE).getValue()));
  ...
  public boolean a(EntityHuman entityhuman) {
    ...
    if (this.isTamed()) {
      ...
      if (!this.world.isClientSide) {
        ...
        if (this.random.nextInt(3) == 0 && !CraftEventFactory.callEntityTameEvent(this, entityhuman)
            .isCancelled()) {
          this.setTamed(true);
          this.navigation.n();
  ...
  public boolean d(ItemStack itemstack) {
    return itemstack != null && (itemstack.getItem() instanceof ItemFood && ((ItemFood) itemstack
        .getItem()).g());
  }
  ...
  public boolean mate(EntityAnimal entityanimal) {
    if (entityanimal == this) {
      ...
      return entitywolf.isTamed() && (!entitywolf.isSitting() && (this.isInLove() && entitywolf
          .isInLove()));
    }
  }
  ...
  public boolean a(EntityLiving entityliving, EntityLiving entityliving1) {
    if (!(entityliving instanceof EntityCreeper) && !(entityliving instanceof EntityGhast)) {
      ...
      return (!(entityliving instanceof EntityHuman) || !(entityliving1 instanceof EntityHuman)
          || ((EntityHuman) entityliving1).a((EntityHuman) entityliving)) && (
