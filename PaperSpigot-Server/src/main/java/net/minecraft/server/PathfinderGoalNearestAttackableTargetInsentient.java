  ...
  public PathfinderGoalNearestAttackableTargetInsentient(EntityInsentient entityinsentient,
    ...
    this.c = new Predicate() {
      public boolean a(EntityLiving entityliving) {
        ...
        return !entityliving.isInvisible() && (
            !((double) entityliving.g(PathfinderGoalNearestAttackableTargetInsentient.this.b) > d0)
                && PathfinderGoalTarget
                .a(PathfinderGoalNearestAttackableTargetInsentient.this.b, entityliving, false,
                    true));
      }
