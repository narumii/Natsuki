...
public class BlockSapling extends BlockPlant implements IBlockFragilePlantElement {
  ...
  public static final BlockStateEnum<BlockWood.EnumLogVariant> TYPE = BlockStateEnum
      .of("type", BlockWood.EnumLogVariant.class);
  ...
  public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
    if (!world.isClientSide) {
      ...
      if (world.getLightLevel(blockposition.up()) >= 9 && (random.nextInt(
          Math.max(2, (int) ((world.growthOdds / world.spigotConfig.saplingModifier * 7) + 0.5F)))
          == 0)) { // Spigot) {
        // CraftBukkit start
        ...
        if (world.capturedBlockStates.size() > 0) {
          ...
          Location location = new Location(world.getWorld(), blockposition.getX(),
  ...
  private boolean a(World world, BlockPosition blockposition, int i, int j,
    ...
    return this.a(world, blockposition.a(i, 0, j), blockwood_enumlogvariant) && this
        .a(world, blockposition.a(i + 1, 0, j), blockwood_enumlogvariant) && this
        .a(world, blockposition.a(i, 0, j + 1), blockwood_enumlogvariant) && this
        .a(world, blockposition.a(i + 1, 0, j + 1), blockwood_enumlogvariant);
  }
  ...
  public boolean a(World world, BlockPosition blockposition,
    ...
    return iblockdata.getBlock() == this
        && iblockdata.get(BlockSapling.TYPE) == blockwood_enumlogvariant;
  }
  ...
  public IBlockData fromLegacyData(int i) {
    return this.getBlockData().set(BlockSapling.TYPE, BlockWood.EnumLogVariant.a(i & 7))
        .set(BlockSapling.STAGE, Integer.valueOf((i & 8) >> 3));
  }
