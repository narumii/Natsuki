...
public abstract class EntityHanging extends Entity {
   ...
   */
  public static AxisAlignedBB calculateBoundingBox(BlockPosition blockPosition,
      EnumDirection direction, int width, int height) {
  ...
  private void updateBoundingBox() {
    if (this.direction != null) {
      ...
      AxisAlignedBB bb = calculateBoundingBox(this.blockPosition, this.direction, this.l(),
          this.m());
  ...
  public boolean l(Entity entity) {
    return entity instanceof EntityHuman && this
        .damageEntity(DamageSource.playerAttack((EntityHuman) entity), 0.0F);
  }
    ...
    if (this.isInvulnerable(damagesource)) {
      ...
      if (!this.dead && !this.world.isClientSide) {
        ...
        if (damagesource.getEntity() != null) {
          event = new org.bukkit.event.hanging.HangingBreakByEntityEvent(
          ...
          if (this instanceof EntityPainting) {
            ...
            paintingEvent = new org.bukkit.event.painting.PaintingBreakByEntityEvent(
                (Painting) this.getBukkitEntity(), damagesource.getEntity() == null ? null
        ...
        if (this.dead || event.isCancelled() || (paintingEvent != null && paintingEvent
            .isCancelled())) {
          return true;
        }
        // CraftBukkit end
  ...
  public void g(double d0, double d1, double d2) {
    if (false && !this.world.isClientSide && !this.dead
        && d0 * d0 + d1 * d1 + d2 * d2 > 0.0D) { // CraftBukkit - not needed
      this.die();
      this.b((Entity) null);
    }
  ...
  public void a(NBTTagCompound nbttagcompound) {
    this.blockPosition = new BlockPosition(nbttagcompound.getInt("TileX"),
        nbttagcompound.getInt("TileY"), nbttagcompound.getInt("TileZ"));
