...
public class BlockFlowing extends BlockFluids {
  ...
  private void f(World world, BlockPosition blockposition, IBlockData iblockdata) {
    world.setTypeAndData(blockposition,
        b(this.material).getBlockData().set(BlockFlowing.LEVEL, iblockdata.get(BlockFlowing.LEVEL)),
        2);
  }
  ...
  public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
    ...
    if (i > 0) {
      ...
      for (Iterator iterator = EnumDirection.EnumDirectionLimit.HORIZONTAL.iterator();
          iterator.hasNext(); l = this.a(world, blockposition.shift(enumdirection), l)) {
      ...
      if (this.a >= 2 && this.material == Material.WATER) {
        ...
        if (iblockdata1.getBlock().getMaterial().isBuildable()) {
          i1 = 0;
            ...
            && iblockdata1.get(BlockFlowing.LEVEL).intValue() == 0) {
          i1 = 0;
        }
      }

      if (!world.paperSpigotConfig.fastDrainLava && this.material == Material.LAVA && i < 8
          && i1 < 8 && i1 > i && random.nextInt(4) != 0) { // PaperSpigot
        j *= 4;
      }
  ...
  private void flow(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
    if (world.isLoaded(blockposition) && this
        .h(world, blockposition, iblockdata)) { // CraftBukkit - add isLoaded check
      ...
      world.setTypeAndData(blockposition,
          this.getBlockData().set(BlockFlowing.LEVEL, Integer.valueOf(i)), 3);
    }
  ...
  private int a(World world, BlockPosition blockposition, int i, EnumDirection enumdirection) {
    ...
    while (iterator.hasNext()) {
      ...
      if (enumdirection1 != enumdirection) {
        ...
        if (!this.g(world, blockposition1, iblockdata) && (
            iblockdata.getBlock().getMaterial() != this.material
                || iblockdata.get(BlockFlowing.LEVEL).intValue() > 0)) {
  ...
  private boolean h(World world, BlockPosition blockposition, IBlockData iblockdata) {
    ...
    return material != this.material && material != Material.LAVA && !this
