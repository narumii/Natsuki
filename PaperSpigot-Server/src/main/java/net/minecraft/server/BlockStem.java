...
public class BlockStem extends BlockPlant implements IBlockFragilePlantElement {
  ...
  protected BlockStem(Block block) {
    this.j(this.blockStateList.getBlockData().set(BlockStem.AGE, Integer.valueOf(0))
        .set(BlockStem.FACING, EnumDirection.UP));
  ...
  public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
    ...
    if (world.getLightLevel(blockposition.up()) >= 9) {
      ...
      if (random.nextInt((int) (
          world.growthOdds / (this == Blocks.PUMPKIN_STEM ? world.spigotConfig.pumpkinModifier
        ...
        if (i < 7) {
          ...
          blockposition = blockposition
              .shift(EnumDirection.EnumDirectionLimit.HORIZONTAL.a(random));
          ...
          if (world.getType(blockposition).getBlock().material == Material.AIR && (
            ...
            CraftEventFactory
                .handleBlockGrowEvent(world, blockposition.getX(), blockposition.getY(),
  ...
  public void g(World world, BlockPosition blockposition, IBlockData iblockdata) {
    ...
    CraftEventFactory.handleBlockGrowEvent(world, blockposition.getX(), blockposition.getY(),
        blockposition.getZ(), this, Math.min(7, i)); // CraftBukkit
  }
  ...
  public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
    this.maxY = (double) (
        (float) (iblockaccess.getType(blockposition).get(BlockStem.AGE).intValue() * 2 + 2)
            / 16.0F);
    float f = 0.125F;
