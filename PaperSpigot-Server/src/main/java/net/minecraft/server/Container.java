...
public abstract class Container {
  ...
  public ArrayList<Slot> c = Lists.newArrayList();
  public int windowId;
  ...
  public void b() {
    for (int i = 0; i < this.c.size(); ++i) {
      ...
      if (!ItemStack.fastMatches(itemstack1, itemstack) || (tickCount % 20 == 0 && !ItemStack
          .matches(itemstack1, itemstack))) { // Spigot
  ...
  public ItemStack clickItem(int i, int j, int k, EntityHuman entityhuman) {
    ...
    if (k == 5) {
      ...
      if ((i1 != 1 || this.g != 2) && i1 != this.g) {
        ...
        if (slot != null && a(slot, playerinventory.getCarried(), true) && slot
            .isAllowed(playerinventory.getCarried()) && playerinventory.getCarried().count > this.h
            .size() && this.b(slot)) {
          this.h.add(slot);
        }
      } else if (this.g == 2) {
        if (!this.h.isEmpty()) {
          ...
          while (iterator.hasNext()) {
            ...
            if (slot1 != null && a(slot1, playerinventory.getCarried(), true) && slot1
                .isAllowed(playerinventory.getCarried())
              ...
              draggedSlots.put(slot1.rawSlotIndex,
                  itemstack2); // CraftBukkit - Put in map instead of setting
            }
          }
      ...
      if ((k == 0 || k == 1) && (j == 0 || j == 1)) {
            ...
            if (itemstack1 == null) {
              ...
              if (itemstack4 == null) {
                ...
                if (itemstack1.getItem() == itemstack4.getItem()
                    && itemstack1.getData() == itemstack4.getData() && ItemStack
                    .equals(itemstack1, itemstack4)) {
                  k1 = j == 0 ? itemstack4.count : 1;
                  ...
                  && itemstack4.getMaxStackSize() > 1 && (!itemstack1.usesData()
                  || itemstack1.getData() == itemstack4.getData()) && ItemStack
                  .equals(itemstack1, itemstack4)) {
                k1 = itemstack1.count;
        ...
        if (slot2.isAllowed(entityhuman)) {
          ...
          boolean flag = itemstack1 == null || slot2.inventory == playerinventory && slot2
              .isAllowed(itemstack1);
      ...
      } else if (k == 3 && entityhuman.abilities.canInstantlyBuild
          && playerinventory.getCarried() == null && i >= 0) {
        slot2 = this.c.get(i);
        ...
        if (itemstack1 != null && (slot2 == null || !slot2.hasItem() || !slot2
            .isAllowed(entityhuman))) {
          l = j == 0 ? 0 : this.c.size() - 1;
          k1 = j == 0 ? 1 : -1;

          for (int l1 = 0; l1 < 2; ++l1) {
            for (int i2 = l;
                i2 >= 0 && i2 < this.c.size() && itemstack1.count < itemstack1.getMaxStackSize();
                i2 += k1) {
              Slot slot3 = this.c.get(i2);

              if (slot3.hasItem() && a(slot3, itemstack1, true) && slot3.isAllowed(entityhuman)
                  && this.a(itemstack1, slot3) && (l1 != 0 || slot3.getItem().count != slot3
                  .getItem().getMaxStackSize())) {
                int j2 = Math
                    .min(itemstack1.getMaxStackSize() - itemstack1.count, slot3.getItem().count);
    ...
    if (itemstack.isStackable()) {
      while (itemstack.count > 0 && (!flag && k < j || flag && k >= i)) {
        ...
        if (itemstack1 != null && itemstack1.getItem() == itemstack.getItem() && (
            !itemstack.usesData() || itemstack.getData() == itemstack1.getData()) && ItemStack
            .equals(itemstack, itemstack1)) {
  ...
  public static boolean a(Slot slot, ItemStack itemstack, boolean flag) {
    ...
    if (slot != null && slot.hasItem() && itemstack != null && itemstack
        .doMaterialsMatch(slot.getItem()) && ItemStack.equals(slot.getItem(), itemstack)) {
  ...
  public static int b(IInventory iinventory) {
    if (iinventory == null) {
      ...
      for (int j = 0; j < iinventory.getSize(); ++j) {
        ...
        if (itemstack != null) {
          f += (float) itemstack.count / (float) Math
              .min(iinventory.getMaxStackSize(), itemstack.getMaxStackSize());
          ++i;
        }
      }
