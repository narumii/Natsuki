...
public class EntityOcelot extends EntityTameableAnimal {
  ...
  public EntityOcelot(World world) {
    ...
    this.targetSelector
        .a(1, new PathfinderGoalRandomTargetNonTamed(this, EntityChicken.class, false, null));
  }
  ...
  public boolean canSpawn() {
    if (this.world.a(this.getBoundingBox(), this) && this.world
        .getCubes(this, this.getBoundingBox()).isEmpty() && !this.world
        .containsLiquid(this.getBoundingBox())) {
      BlockPosition blockposition = new BlockPosition(this.locX, this.getBoundingBox().b,
          this.locZ);
    ...
    if (spawnBonus && this.world.random.nextInt(7) == 0) { // Spigot
      for (int i = 0; i < 2; ++i) {
        ...
        this.world.addEntity(entityocelot,
            org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.OCELOT_BABY); // CraftBukkit - add SpawnReason
      }
    }
