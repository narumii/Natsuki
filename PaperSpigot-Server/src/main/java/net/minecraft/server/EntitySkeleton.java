...
public class EntitySkeleton extends EntityMonster implements IRangedEntity {
  ...
  private PathfinderGoalMeleeAttack b = new PathfinderGoalMeleeAttack(this, EntityHuman.class, 1.2D,
      false);
  ...
  public EntitySkeleton(World world) {
    ...
    this.targetSelector
        .a(3, new PathfinderGoalNearestAttackableTarget(this, EntityIronGolem.class, true));
  ...
  public void die(DamageSource damagesource) {
    ...
    if (damagesource.i() instanceof EntityArrow && damagesource
    ...
    } else if (damagesource.getEntity() instanceof EntityCreeper && ((EntityCreeper) damagesource
        .getEntity()).isPowered() && ((EntityCreeper) damagesource.getEntity()).cp()) {
  ...
  public void a(EntityLiving entityliving, float f) {
    ...
    entityarrow.b((double) (f * 2.0F) + this.random.nextGaussian() * 0.25D + (double) (
        (float) this.world.getDifficulty().a() * 0.11F));
    if (i > 0) {
