...
public class BlockDragonEgg extends Block {
  ...
  private void e(World world, BlockPosition blockposition) {
    if (BlockFalling.canFall(world, blockposition.down()) && blockposition.getY() >= 0) {
      ...
      if (!BlockFalling.instaFall && world
          .areChunksLoadedBetween(blockposition.a(-b0, -b0, -b0), blockposition.a(b0, b0, b0))) {
        ...
        world.addEntity(
            new EntityFallingBlock(loc, world, (double) ((float) blockposition.getX() + 0.5F),
        ...
        for (blockposition1 = blockposition;
            BlockFalling.canFall(world, blockposition1) && blockposition1.getY() > 0;
    ...
    if (iblockdata.getBlock() == this) {
      for (int i = 0; i < 1000; ++i) {
        BlockPosition blockposition1 = blockposition
            .a(world.random.nextInt(16) - world.random.nextInt(16),
        ...
        if (world.getType(blockposition1).getBlock().material == Material.AIR) {
          // CraftBukkit start
          org.bukkit.block.Block from = world.getWorld()
              .getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ());
          org.bukkit.block.Block to = world.getWorld()
          ...
          if (world.isClientSide) {
            for (int j = 0; j < 128; ++j) {
              ...
              world.addParticle(EnumParticle.PORTAL, d1, d2, d3, (double) f, (double) f1,
                  (double) f2);
            }
          } else {
