...
public class BlockTripwire extends Block {
  ...
  public BlockTripwire() {
    ...
    this.j(this.blockStateList.getBlockData().set(BlockTripwire.POWERED, Boolean.valueOf(false))
        ...
        .set(BlockTripwire.ATTACHED, Boolean.valueOf(false))
        .set(BlockTripwire.DISARMED, Boolean.valueOf(false))
        .set(BlockTripwire.NORTH, Boolean.valueOf(false))
        .set(BlockTripwire.EAST, Boolean.valueOf(false))
        .set(BlockTripwire.SOUTH, Boolean.valueOf(false))
        .set(BlockTripwire.WEST, Boolean.valueOf(false)));
  ...
  public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess,
    ...
    return iblockdata.set(BlockTripwire.NORTH,
  ...
  public void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata) {
    iblockdata = iblockdata
        .set(BlockTripwire.SUSPENDED, Boolean.valueOf(!World.a(world, blockposition.down())));
    ...
    if (!world.isClientSide) {
      if (entityhuman.bZ() != null && entityhuman.bZ().getItem() == Items.SHEARS) {
        world.setTypeAndData(blockposition,
            iblockdata.set(BlockTripwire.DISARMED, Boolean.valueOf(true)), 4);
      }
          ...
          if (iblockdata1.getBlock() == Blocks.TRIPWIRE_HOOK) {
            if (iblockdata1.get(BlockTripwireHook.FACING) == enumdirection.opposite()) {
              Blocks.TRIPWIRE_HOOK
                  .a(world, blockposition1, iblockdata1, false, true, k, iblockdata);
            }
  ...
  private void e(World world, BlockPosition blockposition) {
    ...
    boolean flag1 = false;
    List list = world.getEntities(null, new AxisAlignedBB((double) blockposition.getX() + this.minX,
    ...
    if (flag != flag1 && flag1 && iblockdata.get(ATTACHED)) {
      ...
      org.bukkit.block.Block block = bworld
        ...
        if (object != null) {
          ...
          if (object instanceof EntityHuman) {
            cancellable = org.bukkit.craftbukkit.event.CraftEventFactory
                .callPlayerInteractEvent((EntityHuman) object,
  ...
  public static boolean c(IBlockAccess iblockaccess, BlockPosition blockposition,
      IBlockData iblockdata, EnumDirection enumdirection) {
  ...
  protected BlockStateList getStateList() {
    return new BlockStateList(this, BlockTripwire.POWERED, BlockTripwire.SUSPENDED,
        BlockTripwire.ATTACHED, BlockTripwire.DISARMED, BlockTripwire.NORTH, BlockTripwire.EAST,
        BlockTripwire.WEST, BlockTripwire.SOUTH);
  }
}
