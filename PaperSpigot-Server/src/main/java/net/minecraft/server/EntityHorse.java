...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
  ...
  public static final IAttribute attributeJumpStrength = (new AttributeRanged(null,
      "horse.jumpStrength", 0.7D, 0.0D, 2.0D)).a("Jump Strength").a(true);
  private static final String[] bu = new String[]{null,
  ...
  private static final String[] bz = new String[]{null,
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    ...
    return (this.passenger == null || !this.passenger.equals(entity)) && super
  ...
  public void e(float f, float f1) {
    ...
    if (i > 0) {
      ...
      Block block = this.world.getType(
          new BlockPosition(this.locX, this.locY - 0.2D - (double) this.lastYaw, this.locZ))
          .getBlock();
      ...
      if (block.getMaterial() != Material.AIR && !this.R()) {
        ...
        this.world
            .makeSound(this, block_stepsound.getStepSound(), block_stepsound.getVolume1() * 0.5F,
  ...
  public void loadChest() {
    ...
    this.inventoryChest = new InventoryHorseChest("HorseChest", this.cZ(),
        this); // CraftBukkit - add this horse
  ...
  protected String bp() {
    ...
    return i == 3 ? "mob.horse.zombie.death" : (i == 4 ? "mob.horse.skeleton.death"
  ...
  protected String bo() {
    ...
    return i == 3 ? "mob.horse.zombie.hit" : (i == 4 ? "mob.horse.skeleton.hit"
  ...
  protected String z() {
    ...
    return i == 3 ? "mob.horse.zombie.idle" : (i == 4 ? "mob.horse.skeleton.idle"
  ...
  protected String cH() {
    ...
    return i != 3 && i != 4 ? (i != 1 && i != 2 ? "mob.horse.angry" : "mob.horse.donkey.angry")
        : null;
  }
  ...
  protected void a(BlockPosition blockposition, Block block) {
    ...
    if (!block.getMaterial().isLiquid()) {
      ...
      if (this.passenger != null && i != 1 && i != 2) {
        ...
        this.makeSound("mob.horse.soft", block_stepsound.getVolume1() * 0.15F,
            block_stepsound.getVolume2());
      }
    }
  ...
  public boolean a(EntityHuman entityhuman) {
    ...
    if (itemstack != null && itemstack.getItem() == Items.SPAWN_EGG) {
      ...
      if (itemstack != null) {
        ...
        if (!flag && this.cP() && !this.hasChest() && itemstack.getItem() == Item
  ...
  public void m() {
    ...
    if (!this.world.isClientSide) {
      ...
      if (!this.cy() && this.passenger == null && this.random.nextInt(300) == 0 && this.world
          .getType(new BlockPosition(MathHelper.floor(this.locX), (int) Math.floor(this.locY) - 1,
              (int) Math.floor(this.locZ))).getBlock() == Blocks.GRASS) {
        this.r(true);
      }
  ...
  private boolean dg() {
    return this.passenger == null && this.vehicle == null && this.isTame() && this.cn() && !this
        .cS() && this.getHealth() >= this.getMaxHealth() && this.isInLove();
  }
  ...
  public void a(NBTTagCompound nbttagcompound) {
    ...
    if (attributeinstance != null) {
      this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED)
          .setValue(attributeinstance.b() * 0.25D);
    }
  ...
  public EntityAgeable createChild(EntityAgeable entityageable) {
    ...
    double d0 = this.getAttributeInstance(GenericAttributes.maxHealth).b() + entityageable
        .getAttributeInstance(GenericAttributes.maxHealth).b() + (double) this.di();

    entityhorse1.getAttributeInstance(GenericAttributes.maxHealth).setValue(d0 / 3.0D);
    double d1 = this.getAttributeInstance(EntityHorse.attributeJumpStrength).b() + entityageable
        .getAttributeInstance(EntityHorse.attributeJumpStrength).b() + this.dj();

    entityhorse1.getAttributeInstance(EntityHorse.attributeJumpStrength).setValue(d1 / 3.0D);
    double d2 = this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).b() + entityageable
        .getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).b() + this.dk();
  ...
  public void al() {
    ...
    if (this.bK > 0.0F) {
      ...
      this.passenger.setPosition(this.locX + (double) (f2 * f),
          this.locY + this.an() + this.passenger.am() + (double) f3,
  ...
  public static boolean a(Item item) {
    return item == Items.IRON_HORSE_ARMOR || item == Items.GOLDEN_HORSE_ARMOR
  ...
  public boolean d(int i, ItemStack itemstack) {
    if (i == 499 && this.cP()) {
      ...
      if (itemstack != null && itemstack.getItem() == Item.getItemOf(Blocks.CHEST) && !this
          .hasChest()) {
        this.setHasChest(true);
        this.loadChest();
        return true;
