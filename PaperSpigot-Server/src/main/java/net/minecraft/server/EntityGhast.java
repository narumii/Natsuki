...
public class EntityGhast extends EntityFlying implements IMonster {
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    if (this.isInvulnerable(damagesource)) {
      return false;
    } else if ("fireball".equals(damagesource.p()) && damagesource
  ...
  public boolean bR() {
    return this.random.nextInt(20) == 0 && super.bR()
    ...
    public void e() {
      ...
      if (entityliving.h(this.b) < d0 * d0 && this.b.hasLineOfSight(entityliving)) {
        ...
        if (this.a == 20) {
          ...
          double d3 =
              entityliving.getBoundingBox().b + (double) (entityliving.length / 2.0F) - (0.5D
                  + this.b.locY + (double) (this.b.length / 2.0F));
          double d4 = entityliving.locZ - (this.b.locZ + vec3d.c * d1);

          world.a(null, 1008, new BlockPosition(this.b), 0);
          EntityLargeFireball entitylargefireball = new EntityLargeFireball(world, this.b, d2, d3,
              d4);
    ...
    public void e() {
      if (this.a.getGoalTarget() == null) {
        this.a.aI = this.a.yaw =
            -((float) MathHelper.b(this.a.motX, this.a.motZ)) * 180.0F / 3.1415927F;
      } else {
