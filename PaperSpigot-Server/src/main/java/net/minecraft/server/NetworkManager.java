...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
  ...
  public static final LazyInitVar<NioEventLoopGroup> d = new LazyInitVar() {
    protected NioEventLoopGroup a() {
      return new NioEventLoopGroup(0,
          (new ThreadFactoryBuilder()).setNameFormat("Netty Client IO #%d").setDaemon(true)
              .build());
    }
  ...
  public static final LazyInitVar<EpollEventLoopGroup> e = new LazyInitVar() {
    protected EpollEventLoopGroup a() {
      return new EpollEventLoopGroup(0,
          (new ThreadFactoryBuilder()).setNameFormat("Netty Epoll Client IO #%d").setDaemon(true)
              .build());
    }
  ...
  public static final LazyInitVar<LocalEventLoopGroup> f = new LazyInitVar() {
    protected LocalEventLoopGroup a() {
      return new LocalEventLoopGroup(0,
          (new ThreadFactoryBuilder()).setNameFormat("Netty Local Client IO #%d").setDaemon(true)
              .build());
    }
  ...
  public void channelActive(ChannelHandlerContext channelhandlercontext) throws Exception {
    ...
    if (channelhandlercontext.channel().remoteAddress() == null
        || channelhandlercontext.channel().localAddress() == null) {
      channel.close();
    }
  ...
  public void exceptionCaught(ChannelHandlerContext channelhandlercontext, Throwable throwable) {
    ...
    if (throwable instanceof NatsukiException || throwable.getCause() instanceof NatsukiException
        || throwable.getCause().getCause() instanceof NatsukiException) {
  ...
  public void a(Packet packet,
    ...
    if (this.g()) {
      ...
      try {
        this.i.add(new NetworkManager.QueuedPacket(packet, (GenericFutureListener[]) ArrayUtils
            .add(agenericfuturelistener, 0, genericfuturelistener)));
      } finally {
        this.j.writeLock().unlock();
      }
    }
  ...
  public void a(SecretKey secretkey) {
    ...
    this.channel.pipeline()
        .addBefore("splitter", "decrypt", new PacketDecrypter(MinecraftEncryption.a(2, secretkey)));
