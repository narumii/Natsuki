...
public class BlockDaylightDetector extends BlockContainer {
  ...
  public void f(World world, BlockPosition blockposition) {
    if (!world.worldProvider.o()) {
      ...
      if (iblockdata.get(BlockDaylightDetector.POWER).intValue() != i) {
        i = org.bukkit.craftbukkit.event.CraftEventFactory
            .callRedstoneChange(world, blockposition.getX(), blockposition.getY(),
                blockposition.getZ(), iblockdata.get(POWER), i)
            .getNewCurrent(); // CraftBukkit - Call BlockRedstoneEvent
        world.setTypeAndData(blockposition,
            iblockdata.set(BlockDaylightDetector.POWER, Integer.valueOf(i)), 3);
      }
  ...
  public boolean interact(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (entityhuman.cn()) {
      ...
      return super
          .interact(world, blockposition, iblockdata, entityhuman, enumdirection, f, f1, f2);
    }
  }
