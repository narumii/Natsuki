    ...
    if (block.getMaterial() == Material.AIR) {
      ...
      if (this.ticksLived++ == 0) {
        ...
        if (this.world.getType(blockposition).getBlock() == block && !CraftEventFactory
            .callEntityChangeBlockEvent(this, blockposition.getX(), blockposition.getY(),
                blockposition.getZ(), Blocks.AIR, 0).isCancelled()) {
      ...
      if (!this.world.isClientSide) {
        ...
        if (this.onGround) {
          ...
          if (this.world.getType(blockposition).getBlock() != Blocks.PISTON_EXTENSION) {
            this.die();
            if (!this.e) {
              if (this.world.a(block, blockposition, true, EnumDirection.UP, null, null)
                ...
                if (CraftEventFactory
                    .callEntityChangeBlockEvent(this, blockposition.getX(), blockposition.getY(),
                        blockposition.getZ(), this.block.getBlock(),
                        this.block.getBlock().toLegacyData(this.block)).isCancelled()) {
                  return;
                }
                this.world.setTypeAndData(blockposition, this.block, 3);
                world.spigotConfig.antiXrayInstance
                    .updateNearbyBlocks(world, blockposition); // Spigot
                // CraftBukkit end
        ...
        } else if (this.ticksLived > 100 && !this.world.isClientSide && (blockposition.getY() < 1
            || blockposition.getY() > 256) || this.ticksLived > 600) {
    ...
    if (this.hurtEntities) {
      ...
      if (i > 0) {
        ArrayList arraylist = Lists
            .newArrayList(this.world.getEntities(this, this.getBoundingBox()));
  ...
  public void appendEntityCrashDetails(CrashReportSystemDetails crashreportsystemdetails) {
    ...
    if (this.block != null) {
      ...
      crashreportsystemdetails
          .a("Immitating block data", Integer.valueOf(block.toLegacyData(this.block)));
    }
