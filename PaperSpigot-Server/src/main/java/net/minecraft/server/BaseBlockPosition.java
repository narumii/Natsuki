...
public class BaseBlockPosition implements Comparable<BaseBlockPosition> {
  ...
  public boolean equals(final Object object) {
    if (this == object) {
      ...
      return this.getX() == baseblockposition.getX() && (this.getY() == baseblockposition.getY()
  ...
  public int g(final BaseBlockPosition baseblockposition) {
    return this.getY() == baseblockposition.getY() ? (this.getZ() == baseblockposition.getZ() ?
        this.getX() - baseblockposition.getX() : this.getZ() - baseblockposition.getZ())
  ...
  public String toString() {
    return Objects.toStringHelper(this).add("x", this.getX()).add("y", this.getY())
