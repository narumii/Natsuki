...
public abstract class EntityCreature extends EntityInsentient {
  ...
  public static final AttributeModifier bl = (new AttributeModifier(EntityCreature.bk,
      "Fleeing speed bonus", 2.0D, 2)).a(false);
  ...
  public boolean bR() {
    return super.bR()
        && this.a(new BlockPosition(this.locX, this.getBoundingBox().b, this.locZ)) >= 0.0F;
  }
        ...
        if (f > 10.0F) {
          this.world.getServer().getPluginManager().callEvent(
              new EntityUnleashEvent(this.getBukkitEntity(),
                  EntityUnleashEvent.UnleashReason.DISTANCE)); // CraftBukkit
