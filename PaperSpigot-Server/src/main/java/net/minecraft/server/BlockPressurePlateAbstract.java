...
public abstract class BlockPressurePlateAbstract extends Block {
  ...
  private boolean m(World world, BlockPosition blockposition) {
    return World.a(world, blockposition) || world.getType(blockposition)
  ...
  protected void a(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
    ...
    if (flag != flag1) {
      BlockRedstoneEvent eventRedstone = new BlockRedstoneEvent(
          bworld.getBlockAt(blockposition.getX(), blockposition.getY(), blockposition.getZ()), i,
          j);
  ...
  protected AxisAlignedBB getBoundingBox(BlockPosition blockposition) {
    ...
    return new AxisAlignedBB((double) ((float) blockposition.getX() + 0.125F),
        (double) blockposition.getY(), (double) ((float) blockposition.getZ() + 0.125F),
        (double) ((float) (blockposition.getX() + 1) - 0.125F),
        (double) blockposition.getY() + 0.25D,
        (double) ((float) (blockposition.getZ() + 1) - 0.125F));
  }
