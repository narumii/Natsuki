...
public class EntityRabbit extends EntityAnimal {
  ...
  public void initializePathFinderGoals() {
    ...
    this.goalSelector
        .a(2, new PathfinderGoalTempt(this, 1.0D, Item.getItemOf(Blocks.YELLOW_FLOWER), false));
    ...
    this.bm = new EntityRabbit.PathfinderGoalRabbitAvoidTarget(this, EntityWolf.class, 16.0F, 1.33D,
        1.33D);
  ...
  protected float bE() {
    return this.moveController.a() && this.moveController.e() > this.locY + 0.5D ? 0.5F
        : this.bt.b();
  }
  ...
  public void b(double d0) {
    ...
    this.moveController
        .a(this.moveController.d(), this.moveController.e(), this.moveController.f(), d0);
  }
    ...
    if (this.onGround) {
      ...
      if (this.getRabbitType() == 99 && this.bs == 0) {
        ...
        if (entityliving != null && this.h(entityliving) < 16.0D) {
          ...
          this.moveController
              .a(entityliving.locX, entityliving.locY, entityliving.locZ, this.moveController.b());
      ...
      if (!entityrabbit_controllerjumprabbit.c()) {
        if (this.moveController.a() && this.bs == 0) {
          ...
          Vec3D vec3d = new Vec3D(this.moveController.d(), this.moveController.e(),
              this.moveController.f());
  ...
  private void a(double d0, double d1) {
    this.yaw = (float) (MathHelper.b(d1 - this.locZ, d0 - this.locX) * 180.0D / 3.1415927410125732D)
        - 90.0F;
  }
  ...
  public boolean r(Entity entity) {
    if (this.getRabbitType() == 99) {
      this.makeSound("mob.attack", 1.0F,
  ...
  private boolean a(Item item) {
    return item == Items.CARROT || item == Items.GOLDEN_CARROT || item == Item
        .getItemOf(Blocks.YELLOW_FLOWER);
  }
  ...
  public EntityRabbit b(EntityAgeable entityageable) {
    ...
    if (entityageable instanceof EntityRabbit) {
      entityrabbit.setRabbitType(this.random.nextBoolean() ? this.getRabbitType()
          : ((EntityRabbit) entityageable).getRabbitType());
    }
  ...
  public void setRabbitType(int i) {
    if (i == 99) {
      ...
      this.targetSelector
          .a(2, new PathfinderGoalNearestAttackableTarget(this, EntityWolf.class, true));
  ...
  protected void cp() {
    this.world.addParticle(EnumParticle.BLOCK_DUST,
        ...
        0.0D, 0.0D, 0.0D, Block.getCombinedId(Blocks.CARROTS.fromLegacyData(7)));
    this.bu = 100;
  }
  ...
  enum EnumRabbitState {
    ...
    NONE(0.0F, 0.0F, 30, 1), HOP(0.8F, 0.2F, 20, 10), STEP(1.0F, 0.45F, 14, 14), SPRINT(1.75F, 0.4F,
        1, 8), ATTACK(2.0F, 0.7F, 7, 8);
  ...
  static class PathfinderGoalEatCarrots extends PathfinderGoalGotoTarget {
    ...
    public void e() {
      ...
      if (this.f()) {
        ...
        if (this.e && block instanceof BlockCarrots
            && iblockdata.get(BlockCarrots.AGE).intValue() == 7) {
    ...
    protected boolean a(World world, BlockPosition blockposition) {
      ...
      if (block == Blocks.FARMLAND) {
        ...
        if (block instanceof BlockCarrots && iblockdata.get(BlockCarrots.AGE).intValue() == 7
            && this.d && !this.e) {
          this.e = true;
          return true;
        }
  ...
  static class PathfinderGoalRabbitAvoidTarget<T extends Entity> extends
      PathfinderGoalAvoidTarget<T> {

    private EntityRabbit c;

    public PathfinderGoalRabbitAvoidTarget(EntityRabbit entityrabbit, Class<T> oclass, float f,
        double d0, double d1) {
