...
public class WorldGenLargeFeature extends StructureGenerator {
  ...
  private static final List<BiomeBase> d = Arrays
      .asList(BiomeBase.DESERT, BiomeBase.DESERT_HILLS, BiomeBase.JUNGLE, BiomeBase.JUNGLE_HILLS,
          BiomeBase.SWAMPLAND);
  ...
  protected boolean a(int i, int j) {
    ...
    if (k == i1 && l == j1) {
      BiomeBase biomebase = this.c.getWorldChunkManager()
          .getBiome(new BlockPosition(k * 16 + 8, 0, l * 16 + 8));
  ...
  public boolean a(BlockPosition blockposition) {
    ...
    if (structurestart != null
        && structurestart instanceof WorldGenLargeFeature.WorldGenLargeFeatureStart
