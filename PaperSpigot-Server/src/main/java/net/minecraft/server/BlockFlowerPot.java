...
public class BlockFlowerPot extends BlockContainer {
  ...
  public static final BlockStateEnum<BlockFlowerPot.EnumFlowerPotContents> CONTENTS = BlockStateEnum
      .of("contents", BlockFlowerPot.EnumFlowerPotContents.class);
  ...
  public int getDropData(World world, BlockPosition blockposition) {
    ...
    return tileentityflowerpot != null && tileentityflowerpot.b() != null ? tileentityflowerpot.c()
        : 0;
  }
  ...
  static class SyntheticClass_1 {
    ...
    static {
      ...
      try {
        BlockFlowerPot.SyntheticClass_1.b[BlockFlowers.EnumFlowerVarient.ORANGE_TULIP
            .ordinal()] = 6;
  ...
  public enum EnumFlowerPotContents implements INamable {
    ...
    EMPTY("empty"), POPPY("rose"), BLUE_ORCHID("blue_orchid"), ALLIUM("allium"), HOUSTONIA(
        ...
        "white_tulip"), PINK_TULIP("pink_tulip"), OXEYE_DAISY("oxeye_daisy"), DANDELION(
        "dandelion"), OAK_SAPLING("oak_sapling"), SPRUCE_SAPLING("spruce_sapling"), BIRCH_SAPLING(
        "birch_sapling"), JUNGLE_SAPLING("jungle_sapling"), ACACIA_SAPLING(
        "acacia_sapling"), DARK_OAK_SAPLING("dark_oak_sapling"), MUSHROOM_RED(
        "mushroom_red"), MUSHROOM_BROWN("mushroom_brown"), DEAD_BUSH("dead_bush"), FERN(
        "fern"), CACTUS("cactus");
