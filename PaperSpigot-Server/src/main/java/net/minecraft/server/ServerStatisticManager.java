...
public class ServerStatisticManager extends StatisticManager {
    ...
    if (this.d.isFile()) {
      try {
        ...
        ServerStatisticManager.b
            .error("Couldn\'t parse statistics file " + this.d, jsonparseexception);
      }
    }
  ...
  public void setStatistic(EntityHuman entityhuman, Statistic statistic, int i) {
    ...
    if (statistic.d() && j == 0 && i > 0) {
      this.g = true;
      if (this.c.aB()) {
        this.c.getPlayerList().sendMessage(
            new ChatMessage("chat.type.achievement", entityhuman.getScoreboardDisplayName(),
                statistic.j()));
      }
    }
    ...
    if (statistic.d() && j > 0 && i == 0) {
      ...
      if (this.c.aB()) {
        this.c.getPlayerList().sendMessage(
            new ChatMessage("chat.type.achievement.taken", entityhuman.getScoreboardDisplayName(),
                statistic.j()));
      }
    }
    ...
    if (!jsonelement.isJsonObject()) {
      ...
      while (iterator.hasNext()) {
        ...
        if (statistic != null) {
          ...
          if (((JsonElement) entry.getValue()).isJsonPrimitive() && ((JsonElement) entry.getValue())
            ...
            if (jsonobject1.has("progress") && statistic.l() != null) {
              try {
                ...
                IJsonStatistic ijsonstatistic = (IJsonStatistic) constructor
  ...
  public static String a(Map<Statistic, StatisticWrapper> map) {
    ...
    while (iterator.hasNext()) {
      ...
      if (((StatisticWrapper) entry.getValue()).b() != null) {
        ...
        jsonobject1
            .addProperty("value", Integer.valueOf(((StatisticWrapper) entry.getValue()).a()));

        try {
          jsonobject1.add("progress", ((StatisticWrapper) entry.getValue()).b().a());
        } catch (Throwable throwable) {
          ServerStatisticManager.b.warn(
              "Couldn\'t save statistic " + ((Statistic) entry.getKey()).e()
