...
public class PathfinderGoalNearestAttackableTarget<T extends EntityLiving> extends
  ...
  public PathfinderGoalNearestAttackableTarget(EntityCreature entitycreature, Class<T> oclass,
      boolean flag) {
  ...
  public void c() {
    this.e.setGoalTarget(this.d, d instanceof EntityPlayer
