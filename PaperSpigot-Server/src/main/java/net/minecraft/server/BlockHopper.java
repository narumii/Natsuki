...
public class BlockHopper extends BlockContainer {
  ...
  public BlockHopper() {
    ...
    this.j(this.blockStateList.getBlockData().set(BlockHopper.FACING, EnumDirection.DOWN)
        .set(BlockHopper.ENABLED, Boolean.valueOf(true)));
  ...
  public IBlockData getPlacedState(World world, BlockPosition blockposition,
    ...
    return this.getBlockData().set(BlockHopper.FACING, enumdirection1)
        .set(BlockHopper.ENABLED, Boolean.valueOf(true));
  }
  ...
  private void e(World world, BlockPosition blockposition, IBlockData iblockdata) {
    ...
    if (flag != iblockdata.get(BlockHopper.ENABLED).booleanValue()) {
      world
          .setTypeAndData(blockposition, iblockdata.set(BlockHopper.ENABLED, Boolean.valueOf(flag)),
              4);
    }
  ...
  public IBlockData fromLegacyData(int i) {
    return this.getBlockData().set(BlockHopper.FACING, b(i))
        .set(BlockHopper.ENABLED, Boolean.valueOf(f(i)));
  }
