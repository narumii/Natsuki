...
public abstract class BlockButtonAbstract extends Block {
  ...
  protected static boolean a(World world, BlockPosition blockposition,
  ...
  public IBlockData getPlacedState(World world, BlockPosition blockposition,
    ...
    return a(world, blockposition, enumdirection.opposite()) ? this.getBlockData()
        .set(BlockButtonAbstract.FACING, enumdirection)
        .set(BlockButtonAbstract.POWERED, Boolean.valueOf(false))
  ...
  public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (this.e(world, blockposition, iblockdata) && !a(world, blockposition,
        iblockdata.get(BlockButtonAbstract.FACING).opposite())) {
  ...
  public boolean interact(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (iblockdata.get(BlockButtonAbstract.POWERED).booleanValue()) {
      ...
      world.setTypeAndData(blockposition,
          iblockdata.set(BlockButtonAbstract.POWERED, Boolean.valueOf(true)), 3);
      world.b(blockposition, blockposition);
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.3F, 0.6F);
    ...
    if (!world.isClientSide) {
      if (iblockdata.get(BlockButtonAbstract.POWERED).booleanValue()) {
        if (this.N) {
          ...
          this.c(world, blockposition, iblockdata.get(BlockButtonAbstract.FACING));
          world
              .makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D,
                  (double) blockposition.getZ() + 0.5D, "random.click", 0.3F, 0.5F);
          world.b(blockposition, blockposition);
        }
  ...
  private void f(World world, BlockPosition blockposition, IBlockData iblockdata) {
    ...
    List list = world.a(EntityArrow.class,
        new AxisAlignedBB((double) blockposition.getX() + this.minX,
    ...
    if (flag1 != flag && flag) {
      ...
      for (Object object : list) {
        if (object != null) {
          EntityInteractEvent event = new EntityInteractEvent(((Entity) object).getBukkitEntity(),
              block);
    ...
    if (flag && !flag1) {
      ...
      // CraftBukkit end
      world.setTypeUpdate(blockposition,
          iblockdata.set(BlockButtonAbstract.POWERED, Boolean.valueOf(true)));
      this.c(world, blockposition, iblockdata.get(BlockButtonAbstract.FACING));
      world.b(blockposition, blockposition);
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.3F, 0.6F);
  ...
  public IBlockData fromLegacyData(int i) {
    ...
    return this.getBlockData().set(BlockButtonAbstract.FACING, enumdirection)
        .set(BlockButtonAbstract.POWERED, Boolean.valueOf((i & 8) > 0));
  }
