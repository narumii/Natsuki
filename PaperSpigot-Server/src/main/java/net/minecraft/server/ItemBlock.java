...
public class ItemBlock extends Item {
  ...
  public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world,
    ...
    if (itemstack.count == 0) {
      ...
      return false;
    } else if (world.a(this.a, blockposition, false, enumdirection, entityhuman,
        itemstack)) { // PaperSpigot - Pass entityhuman instead of null
      int i = this.filterData(itemstack.getData());
      IBlockData iblockdata1 = this.a
          .getPlacedState(world, blockposition, enumdirection, f, f1, f2, i, entityhuman);
      ...
      if (world.setTypeAndData(blockposition, iblockdata1, 3)) {
        ...
        world.makeSound((double) ((float) blockposition.getX() + 0.5F),
            ...
            (double) ((float) blockposition.getZ() + 0.5F), this.a.stepSound.getPlaceSound(),
            (this.a.stepSound.getVolume1() + 1.0F) / 2.0F, this.a.stepSound.getVolume2() * 0.8F);
        --itemstack.count;
      }
  ...
  public static boolean a(World world, EntityHuman entityhuman, BlockPosition blockposition,
      ItemStack itemstack) {
    ...
    if (minecraftserver == null) {
      ...
      if (itemstack.hasTag() && itemstack.getTag().hasKeyOfType("BlockEntityTag", 10)) {
        ...
        if (tileentity != null) {
          if (!world.isClientSide && tileentity.F() && !minecraftserver.getPlayerList()
              .isOp(entityhuman.getProfile())) {
            return false;
          }
          ...
          NBTTagCompound nbttagcompound2 = (NBTTagCompound) itemstack.getTag()
              .get("BlockEntityTag");
