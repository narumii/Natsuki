...
public abstract class EntityLiving extends Entity {
  ...
  private static final AttributeModifier b = (new AttributeModifier(EntityLiving.a,
      "Sprinting speed boost", 0.30000001192092896D, 2)).a(false);
  ...
  public EntityLiving(World world) {
    ...
    this.datawatcher
        .watch(6, (float) this.getAttributeInstance(GenericAttributes.maxHealth).getValue());
    this.k = true;
      ...
      if (block1.getMaterial() != Material.AIR) {
        ...
        if (this instanceof EntityPlayer) {
          ((WorldServer) this.world)
              .sendParticles((EntityPlayer) this, EnumParticle.BLOCK_DUST, false, this.locX,
                  this.locY, this.locZ, i, 0.0D, 0.0D, 0.0D, 0.15000000596046448D,
                  Block.getCombinedId(iblockdata));
        } else {
          ((WorldServer) this.world)
              .a(EnumParticle.BLOCK_DUST, this.locX, this.locY, this.locZ, i, 0.0D, 0.0D, 0.0D,
                  0.15000000596046448D, Block.getCombinedId(iblockdata));
        }
        // CraftBukkit end
      }
    }
  ...
  public void K() {
    ...
    if (this.isAlive()) {
      if (this.inBlock()) {
        ...
        double d0 =
            this.world.getWorldBorder().a(this) + this.world.getWorldBorder().getDamageBuffer();

        if (d0 < 0.0D) {
          this.damageEntity(DamageSource.STUCK, (float) Math
              .max(1, (int) Math.floor(-d0 * this.world.getWorldBorder().getDamageAmount())));
        }
      }
    }
          ...
          if (this.getAirTicks() == -20) {
            ...
            for (int i = 0; i < 8; ++i) {
              ...
              this.world.addParticle(EnumParticle.WATER_BUBBLE, this.locX + (double) f,
                  this.locY + (double) f1, this.locZ + (double) f2, this.motX, this.motY,
                  this.motZ);
            }
  ...
  public int getExpReward() {
    ...
    if (!this.world.isClientSide && (this.lastDamageByPlayerTime > 0 || this.alwaysGivesExp())
        && this.ba() && this.world.getGameRules().getBoolean("doMobLoot")) {
      return exp;
    } else {
      return 0;
    }
  ...
  protected void aZ() {
    ...
    if (this.deathTicks >= 20
        && !this.dead) { // CraftBukkit - (this.deathTicks == 20) -> (this.deathTicks >= 20 && !this.dead)
      int i;
      ...
      while (i > 0) {
        ...
        i -= j;
        this.world
            .addEntity(new EntityExperienceOrb(this.world, this.locX, this.locY, this.locZ, j));
      }
      this.expToDrop = 0;
      // CraftBukkit end
      ...
      for (i = 0; i < 20; ++i) {
        ...
        this.world.addParticle(EnumParticle.EXPLOSION_NORMAL,
            this.locX + (double) (this.random.nextFloat() * this.width * 2.0F)
                - (double) this.width, this.locY + (double) (this.random.nextFloat() * this.length),
            this.locZ + (double) (this.random.nextFloat() * this.width * 2.0F)
    ...
    if (nbttagcompound.hasKey("Bukkit.MaxHealth")) {
      ...
      if (nbtbase.getTypeId() == 5) {
        this.getAttributeInstance(GenericAttributes.maxHealth)
            .setValue((double) ((NBTTagFloat) nbtbase).c());
  ...
  protected void B() {
    if (this.effects.isEmpty()) {
      ...
      this.datawatcher
          .watch(8, Byte.valueOf((byte) (PotionBrewer.b(this.effects.values()) ? 1 : 0)));
  ...
  protected void a(MobEffect mobeffect) {
    ...
    if (!this.world.isClientSide) {
      MobEffectList.byId[mobeffect.getEffectId()]
          .b(this, this.getAttributeMap(), mobeffect.getAmplifier());
    }
  ...
  protected void a(MobEffect mobeffect, boolean flag) {
    ...
    if (flag && !this.world.isClientSide) {
      MobEffectList.byId[mobeffect.getEffectId()]
          .a(this, this.getAttributeMap(), mobeffect.getAmplifier());
      MobEffectList.byId[mobeffect.getEffectId()]
          .b(this, this.getAttributeMap(), mobeffect.getAmplifier());
    }
  ...
  public void heal(float f, EntityRegainHealthEvent.RegainReason regainReason) {
    ...
    if (f1 > 0.0F) {
      EntityRegainHealthEvent event = new EntityRegainHealthEvent(this.getBukkitEntity(), f,
          regainReason);
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    if (this.isInvulnerable(damagesource)) {
      ...
      if (this.getHealth() <= 0.0F) {
        ...
        if (false && (damagesource == DamageSource.ANVIL
            || damagesource == DamageSource.FALLING_BLOCK) && this.getEquipment(4) != null) {
        ...
        if (flag && !(knockbackCancelled =
            world.paperSpigotConfig.disableExplosionKnockback && damagesource.isExplosion()
          ...
          if (entity != null) {
            ...
            for (d1 = entity.locZ - this.locZ; d0 * d0 + d1 * d1 < 1.0E-4D;
  ...
  public void b(ItemStack itemstack) {
    ...
    for (int i = 0; i < 5; ++i) {
      Vec3D vec3d = new Vec3D(((double) this.random.nextFloat() - 0.5D) * 0.1D,
  ...
  public void die(DamageSource damagesource) {
    ...
    if (!this.world.isClientSide) {
      ...
      if (this.ba() && this.world.getGameRules().getBoolean("doMobLoot")) {
        ...
        if (this.lastDamageByPlayerTime > 0
            && this.random.nextFloat() < 0.025F + (float) i * 0.01F) {
          this.getRareDrop();
        }
  ...
  public boolean k_() {
    ...
    return (block == Blocks.LADDER || block == Blocks.VINE) && (!(this instanceof EntityHuman)
        || !((EntityHuman) this).isSpectator());
  }
  ...
  protected float applyMagicModifier(DamageSource damagesource, float f) {
    if (damagesource.isStarvation()) {
      ...
      if (false && this.hasEffect(MobEffectList.RESISTANCE)
  ...
  protected boolean d(final DamageSource damagesource, float f) { // void -> boolean, add final
    if (!this.isInvulnerable(damagesource)) {
      ...
      EntityDamageEvent event = CraftEventFactory
          .handleLivingEntityDamageEvent(this, damagesource, originalDamage, hardHatModifier,
              blockingModifier, armorModifier, resistanceModifier, magicModifier,
      ...
      if ((damagesource == DamageSource.ANVIL || damagesource == DamageSource.FALLING_BLOCK)
        ...
        this.getEquipment(4).damage(
            (int) (event.getDamage() * 4.0F + this.random.nextFloat() * event.getDamage() * 2.0F),
            this);
      }
  ...
  public EntityLiving bt() {
    return this.combatTracker.c() != null ? this.combatTracker.c()
        : (this.killer != null ? this.killer : (this.lastDamager));
  }
  ...
  private int n() {
    return this.hasEffect(MobEffectList.FASTER_DIG) ? 6
        - (1 + this.getEffect(MobEffectList.FASTER_DIG).getAmplifier()) * 1
        : (this.hasEffect(MobEffectList.SLOWER_DIG) ? 6
            + (1 + this.getEffect(MobEffectList.SLOWER_DIG).getAmplifier()) * 2 : 6);
  }
        ...
        if (i != 0 || j != 0) {
          ...
          if (this.world.a(axisalignedbb).isEmpty()) {
            if (World.a(this.world, new BlockPosition(k, (int) this.locY, l))) {
              this.enderTeleportTo(this.locX + (double) i, this.locY + 1.0D,
                  this.locZ + (double) j);
              return;
            }
  ...
  public void g(float f, float f1) {
    ...
    if (this.bM()) {
      ...
      if (this.V() && (!(this instanceof EntityHuman)
          || !((EntityHuman) this).abilities.isFlying)) {
        d0 = this.locY;
        f3 = 0.8F;
        f4 = 0.02F;
        ...
        this.motZ *= f3;
        this.motY -= 0.02D;
        if (this.positionChanged && this
            .c(this.motX, this.motY + 0.6000000238418579D - this.locY + d0, this.motZ)) {
          this.motY = 0.30000001192092896D;
        }
      } else if (this.ab() && (!(this instanceof EntityHuman)
          || !((EntityHuman) this).abilities.isFlying)) {
        d0 = this.locY;
        this.a(f, f1, 0.02F);
        this.move(this.motX, this.motY, this.motZ);
        ...
        if (this.onGround) {
          f5 = this.world.getType(new BlockPosition(MathHelper.floor(this.locX),
              (int) Math.floor(this.getBoundingBox().b) - 1, (int) Math.floor(this.locZ)))
        ...
        if (this.world.isClientSide && (
            !this.world.isLoaded(new BlockPosition((int) this.locX, 0, (int) this.locZ))
                || !this.world
                .getChunkAtWorldCoords(new BlockPosition((int) this.locX, 0, (int) this.locZ))
                .o())) {
          if (this.locY > 0.0D) {
            this.motY = -0.1D;
          } else {
    ...
    f2 = (float) (Math.sqrt(d0 * d0 + d1 * d1) * 4.0F);
    if (f2 > 1.0F) {
      f2 = 1.0F;
    }
    ...
    if (!this.world.isClientSide) {
      ...
      for (int j = 0; j < 5; ++j) {
        ...
        if (!ItemStack.matches(itemstack1, itemstack)) {
          ((WorldServer) this.world).getTracker()
              .a(this, new PacketPlayOutEntityEquipment(this.getId(), j, itemstack1));
          if (itemstack != null) {
            this.c.a(itemstack.B());
          }
  ...
  public void m() {
    ...
    if (this.bc > 0) {
      ...
      this.pitch = (float) ((double) this.pitch
          + (this.bh - (double) this.pitch) / (double) this.bc);
      --this.bc;
  ...
  protected void bL() {
    List list = this.world
        .a(this, this.getBoundingBox().grow(0.20000000298023224D, 0.0D, 0.20000000298023224D),
            Predicates.and(IEntitySelector.d, new Predicate() {
    ...
    if (this.ad() && !list.isEmpty()) { // Spigot: Add this.ad() condition
      ...
      for (int i = 0; i < list.size(); ++i) {
        ...
        if (entity instanceof EntityLiving && !(this instanceof EntityPlayer)
            && this.ticksLived % 2 == 0) {
          continue;
        }
        // CraftBukkit end
  ...
  public boolean hasLineOfSight(Entity entity) {
    return this.world
        .rayTrace(new Vec3D(this.locX, this.locY + (double) this.getHeadHeight(), this.locZ),
  ...
  protected void ac() {
    this.velocityChanged =
        this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue();
  }
