...
public abstract class NavigationAbstract {
  ...
  public final PathEntity a(double d0, double d1, double d2) {
    return this.a(new BlockPosition(Math.floor(d0), (int) d1, Math.floor(d2)));
  }
  ...
  public PathEntity a(BlockPosition blockposition) {
    if (!this.b()) {
      ...
      int i = (int) (f + 8.0F);
      ChunkCache chunkcache = new ChunkCache(this.c, blockposition1.a(-i, -i, -i),
          blockposition1.a(i, i, i), 0);
  ...
  public PathEntity a(Entity entity) {
    if (!this.b()) {
      ...
      int i = (int) (f + 16.0F);
      ChunkCache chunkcache = new ChunkCache(this.c, blockposition.a(-i, -i, -i),
          blockposition.a(i, i, i), 0);
  ...
  public boolean a(Entity entity, double d0) {
    ...
    if (this.pathfindFailures > 10 && this.d == null
        && MinecraftServer.currentTick < this.lastFailure + 40) {
      return false;
    }
  ...
  public void k() {
    ...
    if (!this.m()) {
      ...
      if (this.b()) {
        ...
        if (vec3d.b > vec3d1.b && !this.b.onGround && (int) Math.floor(vec3d.a) == (int) Math
            .floor(vec3d1.a) && (int) Math.floor(vec3d.c) == (int) Math.floor(vec3d1.c)) {
          this.d.c(this.d.e() + 1);
        }
      }
      ...
      if (!this.m()) {
        ...
        if (vec3d != null) {
          AxisAlignedBB axisalignedbb = (new AxisAlignedBB(vec3d.a, vec3d.b, vec3d.c, vec3d.a,
              vec3d.b, vec3d.c)).grow(0.5D, 0.5D, 0.5D);
          ...
          for (Iterator iterator = list.iterator(); iterator.hasNext();
              d0 = axisalignedbb1.b(axisalignedbb, d0)) {
