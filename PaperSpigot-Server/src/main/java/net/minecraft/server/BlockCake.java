...
public class BlockCake extends Block {
  ...
  public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
    float f = 0.0625F;
    float f1 = (float) (1 + iblockaccess.getType(blockposition).get(BlockCake.BITES).intValue() * 2)
        / 16.0F;
    float f2 = 0.5F;
  ...
  private void b(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (entityhuman.j(false)) {
      ...
      if (i < 6) {
        world.setTypeAndData(blockposition, iblockdata.set(BlockCake.BITES, Integer.valueOf(i + 1)),
            3);
      } else {
