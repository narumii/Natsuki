...
public class EntityTrackerEntry {
  ...
  public void track(List<EntityHuman> list) {
    ...
    if (this.tracker instanceof EntityItemFrame /*&& this.m % 10 == 0*/) { // CraftBukkit - Moved below, should always enter this block
      ...
      if (this.m % 10 == 0 && itemstack != null && itemstack
          .getItem() instanceof ItemWorldMap) { // CraftBukkit - Moved this.m % 10 logic here so item frames do not enter the other blocks
    ...
    if (this.m % this.c == 0 || this.tracker.ai || this.tracker.getDataWatcher().a()) {
      ...
      if (this.tracker.vehicle == null) {
        ...
        Object object = null;
        boolean flag =
            Math.abs(j1) >= 4 || Math.abs(k1) >= 4 || Math.abs(l1) >= 4 || this.m % 60 == 0;
        ...
        if (this.m > 0 || this.tracker instanceof EntityArrow) { // PaperSpigot - Moved up
          ...
          if (j1 >= -128 && j1 < 128 && k1 >= -128 && k1 < 128 && l1 >= -128 && l1 < 128
            ...
            // CraftBukkit end
            object = new PacketPlayOutEntityTeleport(this.tracker.getId(), i, j, k, (byte) l,
        ...
        if (this.u) {
          ...
          if (d4 > d3 * d3 || d4 > 0.0D && this.tracker.motX == 0.0D && this.tracker.motY == 0.0D
            ...
            this.broadcast(
                new PacketPlayOutEntityVelocity(this.tracker.getId(), this.j, this.k, this.l));
          }
        }
  ...
  public void updatePlayer(EntityPlayer entityplayer) {
    ...
    if (entityplayer != this.tracker) {
      if (this.c(entityplayer)) {
        if (!this.trackedPlayers.contains(entityplayer) && (this.e(entityplayer)
          ...
          if (!this.tracker.getDataWatcher().d()) {
            entityplayer.playerConnection.sendPacket(
                new PacketPlayOutEntityMetadata(this.tracker.getId(), this.tracker.getDataWatcher(),
                    true));
          }
          ...
          if (this.u && !(packet instanceof PacketPlayOutSpawnEntityLiving)) {
            entityplayer.playerConnection.sendPacket(
                new PacketPlayOutEntityVelocity(this.tracker.getId(), this.tracker.motX,
                    this.tracker.motY, this.tracker.motZ));
          }
  ...
  public boolean c(EntityPlayer entityplayer) {
    ...
    return d0 >= (double) (-this.b) && d0 <= (double) this.b && d1 >= (double) (-this.b)
        && d1 <= (double) this.b && this.tracker.a(entityplayer);
  }
  ...
  private Packet c() {
    ...
    if (this.tracker instanceof EntityItem) {
      ...
      return new PacketPlayOutSpawnEntity(this.tracker, 73,
          ((EntityPotion) this.tracker).getPotionValue());
