...
public class CommandTp extends CommandAbstract {
    ...
    if (astring.length < 1) {
      ...
      if (astring.length != 1 && astring.length != 2) {
        if (astring.length < b0 + 3) {
          ...
          int i = b0 + 1;
          CommandAbstract.CommandNumber commandabstract_commandnumber = a(((Entity) object).locX,
              astring[b0], true);
          ...
          CommandAbstract.CommandNumber commandabstract_commandnumber2 = a(((Entity) object).locZ,
              astring[i++], true);
          CommandAbstract.CommandNumber commandabstract_commandnumber3 = a(
              (double) ((Entity) object).yaw, astring.length > i ? astring[i++] : "~", false);
          CommandAbstract.CommandNumber commandabstract_commandnumber4 = a(
              (double) ((Entity) object).pitch, astring.length > i ? astring[i] : "~", false);
          float f;
          ...
          if (object instanceof EntityPlayer) {
            ...
            ((EntityPlayer) object).playerConnection
                .a(commandabstract_commandnumber.b(), commandabstract_commandnumber1.b(),
                    commandabstract_commandnumber2.b(), f, f1, enumset);
            ((Entity) object).f(f);
          } else {
          ...
          a(icommandlistener, this, "commands.tp.success.coordinates", ((Entity) object).getName(),
        ...
        if (((Entity) object).getBukkitEntity().teleport(entity.getBukkitEntity(),
          ...
          a(icommandlistener, this, "commands.tp.success", ((Entity) object).getName(),
              entity.getName());
          // CraftBukkit End
        }
      }
  ...
  public List<String> tabComplete(ICommandListener icommandlistener, String[] astring,
    ...
    return astring.length != 1 && astring.length != 2 ? null
        : a(astring, MinecraftServer.getServer().getPlayers());
  }
