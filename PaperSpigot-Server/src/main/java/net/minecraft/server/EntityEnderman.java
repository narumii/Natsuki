...
public class EntityEnderman extends EntityMonster {
  ...
  private static final AttributeModifier b = (new AttributeModifier(EntityEnderman.a,
      "Attacking speed boost", 0.15000000596046448D, 0)).a(false);
  ...
  public EntityEnderman(World world) {
    ...
    this.targetSelector.a(3,
        new PathfinderGoalNearestAttackableTarget(this, EntityEndermite.class, 10, true, false,
            new Predicate() {
  ...
  private boolean c(EntityHuman entityhuman) {
    ...
    if (itemstack != null && itemstack.getItem() == Item.getItemOf(Blocks.PUMPKIN)) {
      ...
      Vec3D vec3d1 = new Vec3D(this.locX - entityhuman.locX,
          this.getBoundingBox().b + (double) (this.length / 2.0F) - (entityhuman.locY
              + (double) entityhuman.getHeadHeight()), this.locZ - entityhuman.locZ);
      double d0 = vec3d1.b();
  ...
  protected boolean b(Entity entity) {
    Vec3D vec3d = new Vec3D(this.locX - entity.locX,
        this.getBoundingBox().b + (double) (this.length / 2.0F) - entity.locY + (double) entity
            .getHeadHeight(), this.locZ - entity.locZ);
  ...
  protected boolean k(double d0, double d1, double d2) {
    ...
    if (this.world.isLoaded(blockposition)) {
      ...
      if (flag1) {
        ...
        // CraftBukkit end
        if (this.world.getCubes(this, this.getBoundingBox()).isEmpty() && !this.world
    ...
    if (!flag) {
      ...
      for (int i = 0; i < short0; ++i) {
        ...
        double d7 = d3 + (this.locX - d3) * d6
            + (this.random.nextDouble() - 0.5D) * (double) this.width * 2.0D;
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    if (this.isInvulnerable(damagesource)) {
      ...
      if (damagesource.getEntity() == null || !(damagesource
          .getEntity() instanceof EntityEndermite)) {
        if (!this.world.isClientSide) {
          this.a(true);
        }

        if (damagesource instanceof EntityDamageSource && damagesource
            .getEntity() instanceof EntityHuman) {
          if (damagesource.getEntity() instanceof EntityPlayer && ((EntityPlayer) damagesource
              .getEntity()).playerInteractManager.isCreative()) {
            this.a(false);
          } else {
            this.bm = true;
          }
  ...
  static class PathfinderGoalEndermanPickupBlock extends PathfinderGoal {
    ...
    public boolean a() {
      return this.enderman.world.getGameRules().getBoolean("mobGriefing") && (
          this.enderman.getCarried().getBlock().getMaterial() == Material.AIR
    ...
    public void e() {
      ...
      if (EntityEnderman.c.contains(block)) {
        ...
        if (!org.bukkit.craftbukkit.event.CraftEventFactory
            .callEntityChangeBlockEvent(this.enderman, this.enderman.world.getWorld()
  ...
  static class PathfinderGoalEndermanPlaceBlock extends PathfinderGoal {
    ...
    public boolean a() {
      return this.a.world.getGameRules().getBoolean("mobGriefing") && (
          this.a.getCarried().getBlock().getMaterial() != Material.AIR
      ...
      if (this.a(world, blockposition, this.a.getCarried().getBlock(), block, block1)) {
        ...
        if (!org.bukkit.craftbukkit.event.CraftEventFactory
            .callEntityChangeBlockEvent(this.a, blockposition.getX(), blockposition.getY(),
                ...
                this.a.getCarried().getBlock().toLegacyData(this.a.getCarried())).isCancelled()) {
    ...
    private boolean a(World world, BlockPosition blockposition, Block block, Block block1,
        Block block2) {
      return block.canPlace(world, blockposition) && (block1.getMaterial() == Material.AIR && (
          block2.getMaterial() != Material.AIR && block2.d()));
    }
  }
  ...
  static class PathfinderGoalPlayerWhoLookedAtTarget extends PathfinderGoalNearestAttackableTarget {
    ...
    public boolean a() {
      ...
      List list = this.e.world
          .a(EntityHuman.class, this.e.getBoundingBox().grow(d0, 4.0D, d0), this.c);
    ...
    public void d() {
      this.g = null;
      this.j.a(false);
      AttributeInstance attributeinstance = this.j
