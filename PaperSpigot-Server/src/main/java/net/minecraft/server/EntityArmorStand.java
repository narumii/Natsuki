...
public class EntityArmorStand extends EntityLiving {
  ...
  public boolean d(int i, ItemStack itemstack) {
    ...
    if (itemstack != null && EntityInsentient.c(itemstack) != j && (j != 4 || !(itemstack
  ...
  public void b(NBTTagCompound nbttagcompound) {
    ...
    if (this.getCustomNameVisible() && (this.getCustomName() == null
        || this.getCustomName().length() == 0)) {
  ...
  protected void bL() {
    ...
    if (list != null && !list.isEmpty()) {
      for (int i = 0; i < list.size(); ++i) {
        ...
        if (entity instanceof EntityMinecartAbstract && ((EntityMinecartAbstract) entity).s()
            == EntityMinecartAbstract.EnumMinecartType.RIDEABLE && this.h(entity) <= 0.2D) {
          entity.collide(this);
        }
      }
    }
  ...
  public boolean a(EntityHuman entityhuman, Vec3D vec3d) {
    if (this.s()) {
      ...
      if (flag && (itemstack.getItem() == Items.SKULL || itemstack.getItem() == Item
          .getItemOf(Blocks.PUMPKIN))) {
        b0 = 4;
      }
    ...
    if (itemstack == null || (this.bi & 1 << i + 8) == 0) {
      if (itemstack != null || (this.bi & 1 << i + 16) == 0) {
        ...
        PlayerArmorStandManipulateEvent armorStandManipulateEvent = new PlayerArmorStandManipulateEvent(
            player, self, playerHeldItem, armorStandItem, slot);
        ...
        if (entityhuman.abilities.canInstantlyBuild && (itemstack == null
            || itemstack.getItem() == Item.getItemOf(Blocks.AIR)) && itemstack1 != null) {
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    ...
    if (org.bukkit.craftbukkit.event.CraftEventFactory
        .handleNonLivingEntityDamageEvent(this, damagesource, f)) {
      return false;
    }
    // CraftBukkit end
  ...
  private void A() {
    if (this.world instanceof WorldServer) {
      ((WorldServer) this.world)
          .a(EnumParticle.BLOCK_DUST, this.locX, this.locY + (double) this.length / 1.5D, this.locZ,
              10, (double) (this.width / 4.0F), (double) (this.length / 4.0F),
