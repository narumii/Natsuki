...
public class CrashReport {
  ...
  private void h() {
    ...
    this.d.a("Memory", new Callable() {
      public String a() {
        ...
        return k + " bytes (" + j1 + " MB) / " + j + " bytes (" + i1 + " MB) up to " + i
            + " bytes (" + l + " MB)";
      }
  ...
  public void a(StringBuilder stringbuilder) {
    ...
    while (iterator.hasNext()) {
      CrashReportSystemDetails crashreportsystemdetails = (CrashReportSystemDetails) iterator
          .next();
  ...
  private static String i() {
    String[] astring = new String[]{"Who set us up the TNT?",
        ...
        "This doesn\'t make any sense!", "Why is it breaking :(", "Don\'t do that.",
        "Ouch. That hurt :(", "You\'re mean.",
