...
public class ChunkProviderHell implements IChunkProvider {
  ...
  public ChunkProviderHell(World world, boolean flag, long i) {
    this.w = new WorldGenMinable(Blocks.QUARTZ_ORE.getBlockData(), 14,
        BlockPredicate.a(Blocks.NETHERRACK));
      ...
      for (int i1 = 0; i1 < 16; ++i1) {
        ...
        for (int l1 = 127; l1 >= 0; --l1) {
          ...
          if (l1 < 127 - (h.paperSpigotConfig.generateFlatBedrock ? 0 : this.j.nextInt(5)) &&
            ...
            if (iblockdata2.getBlock() != null
                && iblockdata2.getBlock().getMaterial() != Material.AIR) {
  ...
  public Chunk getOrCreateChunk(int i, int j) {
    ...
    BiomeBase[] abiomebase = this.h.getWorldChunkManager()
