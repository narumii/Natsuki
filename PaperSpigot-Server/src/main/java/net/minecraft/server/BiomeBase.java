...
public abstract class BiomeBase {
  ...
  public static final BiomeBase DESERT = (new BiomeDesert(2)).b(16421912).a("Desert").b()
      .a(2.0F, 0.0F).a(BiomeBase.e);
  public static final BiomeBase EXTREME_HILLS = (new BiomeBigHills(3, false)).b(6316128)
      .a("Extreme Hills").a(BiomeBase.i).a(0.2F, 0.3F);
  public static final BiomeBase FOREST = (new BiomeForest(4, 0)).b(353825).a("Forest");
  public static final BiomeBase TAIGA = (new BiomeTaiga(5, 0)).b(747097).a("Taiga").a(5159473)
      .a(0.25F, 0.8F).a(BiomeBase.f);
  public static final BiomeBase SWAMPLAND = (new BiomeSwamp(6)).b(522674).a("Swampland").a(9154376)
      .a(BiomeBase.m).a(0.8F, 0.9F);
  ...
  public static final BiomeBase FROZEN_OCEAN = (new BiomeOcean(10)).b(9474208).a("FrozenOcean").c()
      .a(BiomeBase.c).a(0.0F, 0.5F);
  public static final BiomeBase FROZEN_RIVER = (new BiomeRiver(11)).b(10526975).a("FrozenRiver").c()
      .a(BiomeBase.b).a(0.0F, 0.5F);
  public static final BiomeBase ICE_PLAINS = (new BiomeIcePlains(12, false)).b(16777215)
      .a("Ice Plains").c().a(0.0F, 0.5F).a(BiomeBase.e);
  public static final BiomeBase ICE_MOUNTAINS = (new BiomeIcePlains(13, false)).b(10526880)
      .a("Ice Mountains").c().a(BiomeBase.g).a(0.0F, 0.5F);
  public static final BiomeBase MUSHROOM_ISLAND = (new BiomeMushrooms(14)).b(16711935)
      .a("MushroomIsland").a(0.9F, 1.0F).a(BiomeBase.l);
  public static final BiomeBase MUSHROOM_SHORE = (new BiomeMushrooms(15)).b(10486015)
      .a("MushroomIslandShore").a(0.9F, 1.0F).a(BiomeBase.j);
  public static final BiomeBase BEACH = (new BiomeBeach(16)).b(16440917).a("Beach").a(0.8F, 0.4F)
      .a(BiomeBase.j);
  public static final BiomeBase DESERT_HILLS = (new BiomeDesert(17)).b(13786898).a("DesertHills")
      .b().a(2.0F, 0.0F).a(BiomeBase.g);
  public static final BiomeBase FOREST_HILLS = (new BiomeForest(18, 0)).b(2250012).a("ForestHills")
      .a(BiomeBase.g);
  public static final BiomeBase TAIGA_HILLS = (new BiomeTaiga(19, 0)).b(1456435).a("TaigaHills")
      .a(5159473).a(0.25F, 0.8F).a(BiomeBase.g);
  public static final BiomeBase SMALL_MOUNTAINS = (new BiomeBigHills(20, true)).b(7501978)
      .a("Extreme Hills Edge").a(BiomeBase.i.a()).a(0.2F, 0.3F);
  public static final BiomeBase JUNGLE = (new BiomeJungle(21, false)).b(5470985).a("Jungle")
      .a(5470985).a(0.95F, 0.9F);
  public static final BiomeBase JUNGLE_HILLS = (new BiomeJungle(22, false)).b(2900485)
      .a("JungleHills").a(5470985).a(0.95F, 0.9F).a(BiomeBase.g);
  public static final BiomeBase JUNGLE_EDGE = (new BiomeJungle(23, true)).b(6458135).a("JungleEdge")
      .a(5470985).a(0.95F, 0.8F);
  public static final BiomeBase DEEP_OCEAN = (new BiomeOcean(24)).b(48).a("Deep Ocean")
      .a(BiomeBase.d);
  public static final BiomeBase STONE_BEACH = (new BiomeStoneBeach(25)).b(10658436).a("Stone Beach")
      .a(0.2F, 0.3F).a(BiomeBase.k);
  public static final BiomeBase COLD_BEACH = (new BiomeBeach(26)).b(16445632).a("Cold Beach")
      .a(0.05F, 0.3F).a(BiomeBase.j).c();
  public static final BiomeBase BIRCH_FOREST = (new BiomeForest(27, 2)).a("Birch Forest")
      .b(3175492);
  public static final BiomeBase BIRCH_FOREST_HILLS = (new BiomeForest(28, 2))
      .a("Birch Forest Hills").b(2055986).a(BiomeBase.g);
  public static final BiomeBase ROOFED_FOREST = (new BiomeForest(29, 3)).b(4215066)
      .a("Roofed Forest");
  public static final BiomeBase COLD_TAIGA = (new BiomeTaiga(30, 0)).b(3233098).a("Cold Taiga")
      .a(5159473).c().a(-0.5F, 0.4F).a(BiomeBase.f).c(16777215);
  public static final BiomeBase COLD_TAIGA_HILLS = (new BiomeTaiga(31, 0)).b(2375478)
      .a("Cold Taiga Hills").a(5159473).c().a(-0.5F, 0.4F).a(BiomeBase.g).c(16777215);
  public static final BiomeBase MEGA_TAIGA = (new BiomeTaiga(32, 1)).b(5858897).a("Mega Taiga")
      .a(5159473).a(0.3F, 0.8F).a(BiomeBase.f);
  public static final BiomeBase MEGA_TAIGA_HILLS = (new BiomeTaiga(33, 1)).b(4542270)
      .a("Mega Taiga Hills").a(5159473).a(0.3F, 0.8F).a(BiomeBase.g);
  public static final BiomeBase EXTREME_HILLS_PLUS = (new BiomeBigHills(34, true)).b(5271632)
      .a("Extreme Hills+").a(BiomeBase.i).a(0.2F, 0.3F);
  public static final BiomeBase SAVANNA = (new BiomeSavanna(35)).b(12431967).a("Savanna")
      .a(1.2F, 0.0F).b().a(BiomeBase.e);
  public static final BiomeBase SAVANNA_PLATEAU = (new BiomeSavanna(36)).b(10984804)
      .a("Savanna Plateau").a(1.0F, 0.0F).b().a(BiomeBase.h);
  public static final BiomeBase MESA = (new BiomeMesa(37, false, false)).b(14238997).a("Mesa");
  public static final BiomeBase MESA_PLATEAU_F = (new BiomeMesa(38, false, true)).b(11573093)
      .a("Mesa Plateau F").a(BiomeBase.h);
  public static final BiomeBase MESA_PLATEAU = (new BiomeMesa(39, false, false)).b(13274213)
      .a("Mesa Plateau").a(BiomeBase.h);
  ...
  protected BiomeBase a(final float f, final float f1) {
    if (f > 0.1F && f < 0.2F) {
  ...
  protected final BiomeBase a(final BiomeTemperature biomebase_biometemperature) {
  ...
  public BlockFlowers.EnumFlowerVarient a(final Random random, final BlockPosition blockposition) {
    return random.nextInt(3) > 0 ? BlockFlowers.EnumFlowerVarient.DANDELION
        : BlockFlowers.EnumFlowerVarient.POPPY;
  }
  ...
  protected BiomeBase a(final String s) {
    this.ah = s;
    return this;
  }

  protected BiomeBase a(final int i) {
    this.am = i;
    return this;
  }

  protected BiomeBase b(final int i) {
    this.a(i, false);
    return this;
  }

  protected BiomeBase c(final int i) {
    this.aj = i;
    return this;
  }

  protected BiomeBase a(final int i, final boolean flag) {
    this.ai = i;
    if (flag) {
  ...
  public List<BiomeMeta> getMobs(final EnumCreatureType enumcreaturetype) {
  ...
  public final float a(final BlockPosition blockposition) {
    if (blockposition.getY() > 64) {
      final float f = (float) (BiomeBase.ae.a((double) blockposition.getX() * 1.0D / 8.0D,
  ...
  public void a(final World world, final Random random, final BlockPosition blockposition) {
  ...
  public void a(final World world, final Random random, final ChunkSnapshot chunksnapshot,
      final int i, final int j, final double d0) {
    this.b(world, random, chunksnapshot, i, j, d0);
  }

  public final void b(final World world, final Random random, final ChunkSnapshot chunksnapshot,
      final int i, final int j, final double d0) {
    final int k = world.F();
    IBlockData iblockdata = this.ak;
    IBlockData iblockdata1 = this.al;
    int l = -1;
    final int i1 = (int) (d0 / 3.0D + 3.0D + random.nextDouble() * 0.25D);
    final int j1 = i & 15;
    final int k1 = j & 15;
    final BlockPosition.MutableBlockPosition blockposition_mutableblockposition = new BlockPosition.MutableBlockPosition();

    for (int l1 = 255; l1 >= 0; --l1) {
      if (l1 <= (world.paperSpigotConfig.generateFlatBedrock ? 0
          : random.nextInt(5))) { // PaperSpigot - Configurable flat bedrock
        chunksnapshot.a(k1, l1, j1, Blocks.BEDROCK.getBlockData());
      } else {
        final IBlockData iblockdata2 = chunksnapshot.a(k1, l1, j1);
          ...
          if (l == -1) {
            ...
            if (l == 0 && iblockdata1.getBlock() == Blocks.SAND) {
              ...
              iblockdata1 = iblockdata1.get(BlockSand.VARIANT) == BlockSand.EnumSandVariant.RED_SAND
                  ? Blocks.RED_SANDSTONE.getBlockData() : Blocks.SANDSTONE.getBlockData();
            }
          }
        }
      }
  ...
  public static BiomeBase getBiome(final int i) {
    return getBiome(i, null);
  }

  public static BiomeBase getBiome(final int i, final BiomeBase biomebase) {
    if (i >= 0 && i <= BiomeBase.biomes.length) {
      final BiomeBase biomebase1 = BiomeBase.biomes[i];
  ...
  static {
    ...
    final BiomeBase[] abiomebase = BiomeBase.biomes;
    final int i = abiomebase.length;

    for (int j = 0; j < i; ++j) {
      final BiomeBase biomebase = abiomebase[j];

      if (biomebase != null) {
        if (BiomeBase.o.containsKey(biomebase.ah)) {
          throw new Error("Biome \"" + biomebase.ah + "\" is defined as both ID " + BiomeBase.o
              .get(biomebase.ah).id + " and " + biomebase.id);
        }
  ...
  public static class BiomeMeta extends WeightedRandom.WeightedRandomChoice {
    ...
    public BiomeMeta(final Class<? extends EntityInsentient> oclass, final int i, final int j,
        final int k) {
      super(i);
      this.b = oclass;
      this.c = j;
  ...
  public static class BiomeTemperature {
    ...
    public BiomeTemperature(final float f, final float f1) {
      this.a = f;
      this.b = f1;
    }
