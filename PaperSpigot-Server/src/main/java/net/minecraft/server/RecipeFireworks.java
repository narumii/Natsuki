...
public class RecipeFireworks extends ShapelessRecipes implements
  ...
  public RecipeFireworks() {
    super(new ItemStack(Items.FIREWORKS, 0, 0),
        java.util.Arrays.asList(new ItemStack(Items.GUNPOWDER, 0, 5)));
  }
  // CraftBukkit end
      ...
      if (j >= 1 && i == 1 && i1 == 0) {
        ...
        if (l > 0) {
          ...
          for (int l1 = 0; l1 < inventorycrafting.getSize(); ++l1) {
            ...
            if (itemstack1 != null && itemstack1.getItem() == Items.FIREWORK_CHARGE && itemstack1
                .hasTag() && itemstack1.getTag().hasKeyOfType("Explosion", 10)) {
