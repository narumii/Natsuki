...
public class ChatModifier {
  ...
  public boolean g() {
    return this.c == null && this.d == null && this.f == null && this.e == null && this.g == null
        && this.b == null && this.h == null && this.i == null;
  }
  ...
  public String toString() {
    return "Style{hasParent=" + (this.a != null) + ", color=" + this.b + ", bold=" + this.c
        + ", italic=" + this.d + ", underlined=" + this.e + ", obfuscated=" + this.g
        + ", clickEvent=" + this.h() + ", hoverEvent=" + this.i() + ", insertion=" + this.j() + '}';
  }
  ...
  public boolean equals(Object object) {
    if (this == object) {
      ...
      if (this.isBold() == chatmodifier.isBold() && this.getColor() == chatmodifier.getColor()
          && this.isItalic() == chatmodifier.isItalic() && this.isRandom() == chatmodifier
          .isRandom() && this.isStrikethrough() == chatmodifier.isStrikethrough()
  ...
  public static class ChatModifierSerializer implements JsonDeserializer<ChatModifier>,
      JsonSerializer<ChatModifier> {

    public ChatModifierSerializer() {
    }

    public ChatModifier a(JsonElement jsonelement, Type type,
        ...
        if (jsonobject == null) {
          ...
          if (jsonobject.has("clickEvent")) {
            ...
            if (jsonobject1 != null) {
              ...
              ChatClickable.EnumClickAction chatclickable_enumclickaction =
          ...
          if (jsonobject.has("hoverEvent")) {
            ...
            if (jsonobject1 != null) {
              jsonprimitive = jsonobject1.getAsJsonPrimitive("action");
              ChatHoverable.EnumHoverAction chathoverable_enumhoveraction =
                  jsonprimitive == null ? null
              ...
              if (chathoverable_enumhoveraction != null && ichatbasecomponent != null
                ...
                chatmodifier.i = new ChatHoverable(chathoverable_enumhoveraction,
                    ichatbasecomponent);
              }
            }
          }
    ...
    public JsonElement a(ChatModifier chatmodifier, Type type,
    ...
    public ChatModifier deserialize(JsonElement jsonelement, Type type,
        ...
        throws JsonParseException { // CraftBukkit - fix decompile error
