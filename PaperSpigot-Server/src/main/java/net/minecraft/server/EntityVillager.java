...
public class EntityVillager extends EntityAgeable implements IMerchant, NPC {
  ...
  public EntityVillager(World world, int i) {
    ...
    this.inventory = new InventorySubcontainer("Items", false, 8,
        (CraftVillager) this.getBukkitEntity()); // CraftBukkit add argument
    ...
    this.goalSelector
        .a(1, new PathfinderGoalAvoidTarget(this, EntityZombie.class, 8.0F, 0.6D, 0.6D));
  ...
  public void a(MerchantRecipe merchantrecipe) {
    ...
    if (merchantrecipe.j()) {
      this.world.addEntity(
          new EntityExperienceOrb(this.world, this.locX, this.locY + 0.5D, this.locZ, i));
    }
  ...
  private boolean a(Item item) {
    return item == Items.BREAD || item == Items.POTATO || item == Items.CARROT
        || item == Items.WHEAT || item == Items.WHEAT_SEEDS;
  }
  ...
  static class MerchantRecipeOptionProcess implements EntityVillager.IMerchantRecipeOption {
    ...
    public void a(MerchantRecipeList merchantrecipelist, Random random) {
      ...
      merchantrecipelist.add(
          new MerchantRecipe(new ItemStack(this.a.getItem(), i, this.a.getData()),
  ...
  static class MerchantRecipeOptionBook implements EntityVillager.IMerchantRecipeOption {
    ...
    public void a(MerchantRecipeList merchantrecipelist, Random random) {
      ...
      merchantrecipelist.add(
          new MerchantRecipe(new ItemStack(Items.BOOK), new ItemStack(Items.EMERALD, j),
              itemstack));
    }
  }
