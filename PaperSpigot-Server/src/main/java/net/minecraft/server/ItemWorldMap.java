...
public class ItemWorldMap extends ItemWorldMapBase {
  ...
  public WorldMap getSavedMap(ItemStack itemstack, World world) {
    World worldMain = world.getServer().getServer().worlds
        .get(0); // CraftBukkit - store reference to primary world
    String s = "map_" + itemstack.getData();
    WorldMap worldmap = (WorldMap) worldMain
        .a(WorldMap.class, s); // CraftBukkit - use primary world for maps
  ...
  public void a(World world, Entity entity, WorldMap worldmap) {
    ...
    if (((WorldServer) world).dimension == worldmap.map && entity instanceof EntityHuman) {
      ...
      WorldMap.WorldMapHumanTracker worldmap_worldmaphumantracker = worldmap
          .a((EntityHuman) entity);
            ...
            if (k1 >= 0 && l1 >= -1 && k1 < 128 && l1 < 128) {
              ...
              if (!chunk.isEmpty()) {
                ...
                if (world.worldProvider.o()) {
                  ...
                  if ((l3 >> 20 & 1) == 0) {
                    hashmultiset.add(Blocks.DIRT.g(Blocks.DIRT.getBlockData()
                        .set(BlockDirt.VARIANT, BlockDirt.EnumDirtVariant.DIRT)), 10);
                  } else {
  ...
  public void d(ItemStack itemstack, World world, EntityHuman entityhuman) {
    if (itemstack.hasTag() && itemstack.getTag().getBoolean("map_is_scaling")) {
      ...
      world = world.getServer().getServer().worlds
          .get(0); // CraftBukkit - use primary world for maps
