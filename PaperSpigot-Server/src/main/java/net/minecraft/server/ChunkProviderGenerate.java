...
public class ChunkProviderGenerate implements IChunkProvider {
          ...
          for (int l2 = 0; l2 < 8; ++l2) {
            ...
            for (int i3 = 0; i3 < 4; ++i3) {
              ...
              for (int j3 = 0; j3 < 4; ++j3) {
                if ((d16 += d15) > 0.0D) {
                  chunksnapshot
                      .a(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, Blocks.STONE.getBlockData());
  ...
  public void a(int i, int j, ChunkSnapshot chunksnapshot, BiomeBase[] abiomebase) {
    ...
    this.t = this.l
        .a(this.t, (double) (i * 16), (double) (j * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
  ...
  public List<BiomeBase.BiomeMeta> getMobsFor(EnumCreatureType enumcreaturetype,
    ...
    if (this.n) {
      ...
      if (enumcreaturetype == EnumCreatureType.MONSTER && this.r.y && this.A
          .a(this.m, blockposition)) {
        return this.A.b();
      }
    }
  ...
  public BlockPosition findNearestMapFeature(World world, String s, BlockPosition blockposition) {
    return "Stronghold".equals(s) && this.v != null ? this.v
        .getNearestGeneratedFeature(world, blockposition) : null;
  }
