...
public class EntitySmallFireball extends EntityFireball {
  ...
  public EntitySmallFireball(World world, EntityLiving entityliving, double d0, double d1,
      double d2) {
    super(world, entityliving, d0, d1, d2);
    this.setSize(0.3125F, 0.3125F);
  }

  public EntitySmallFireball(World world, double d0, double d1, double d2, double d3, double d4,
      double d5) {
  ...
  protected void a(MovingObjectPosition movingobjectposition) {
    if (!this.world.isClientSide) {
      ...
      if (movingobjectposition.entity != null) {
        flag = movingobjectposition.entity
            .damageEntity(DamageSource.fireball(this, this.shooter), 5.0F);
        if (flag) {
          ...
          if (!movingobjectposition.entity.isFireProof()) {
            ...
            EntityCombustByEntityEvent event = new EntityCombustByEntityEvent(
                this.getBukkitEntity(), movingobjectposition.entity.getBukkitEntity(), 5);
        ...
        if (flag) {
          BlockPosition blockposition = movingobjectposition.a()
              .shift(movingobjectposition.direction);

          if (this.world.isEmpty(blockposition)) {
            // CraftBukkit start
            if (isIncendiary && !org.bukkit.craftbukkit.event.CraftEventFactory
