...
public class GenericAttributes {
  ...
  // Spigot start
  public static final IAttribute maxHealth = (new AttributeRanged(null, "generic.maxHealth", 20.0D,
      0.1D, org.spigotmc.SpigotConfig.maxHealth)).a("Max Health").a(true);
  public static final IAttribute FOLLOW_RANGE = (new AttributeRanged(null, "generic.followRange",
      32.0D, 0.0D, 2048.0D)).a("Follow Range");
  ...
  public static final IAttribute MOVEMENT_SPEED = (new AttributeRanged(null,
      "generic.movementSpeed", 0.699999988079071D, 0.0D, org.spigotmc.SpigotConfig.movementSpeed))
      .a("Movement Speed").a(true);
  public static final IAttribute ATTACK_DAMAGE = new AttributeRanged(null, "generic.attackDamage",
      2.0D, 0.0D, org.spigotmc.SpigotConfig.attackDamage);
  // Spigot end
  ...
  public static void a(AttributeMapBase attributemapbase, NBTTagList nbttaglist) {
    for (int i = 0; i < nbttaglist.size(); ++i) {
      ...
      if (attributeinstance != null) {
        ...
        GenericAttributes.f
            .warn("Ignoring unknown attribute \'" + nbttagcompound.getString("Name") + "\'");
      }
    }
  ...
  public static AttributeModifier a(NBTTagCompound nbttagcompound) {
    ...
    try {
      return new AttributeModifier(uuid, nbttagcompound.getString("Name"),
          nbttagcompound.getDouble("Amount"), nbttagcompound.getInt("Operation"));
