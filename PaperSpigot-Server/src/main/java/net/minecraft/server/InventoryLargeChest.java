...
public class InventoryLargeChest implements ITileInventory {
  ...
  public InventoryLargeChest(String s, ITileInventory itileinventory,
  ...
  public ItemStack getItem(int i) {
    return i >= this.left.getSize() ? this.right.getItem(i - this.left.getSize())
        : this.left.getItem(i);
  }
  ...
  public int getMaxStackSize() {
    return Math.min(this.left.getMaxStackSize(),
        this.right.getMaxStackSize()); // CraftBukkit - check both sides
  }
