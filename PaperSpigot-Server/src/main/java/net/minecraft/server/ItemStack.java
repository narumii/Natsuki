...
public final class ItemStack {
  ...
  public boolean placeItem(EntityHuman entityhuman, World world, BlockPosition blockposition,
    ...
    if (flag && world.captureTreeGeneration && world.capturedBlockStates.size() > 0) {
      ...
      if (treeType != null) {
        ...
        event = new StructureGrowEvent(location, treeType, isBonemeal,
            (Player) entityhuman.getBukkitEntity(), blocks);
    ...
    if (flag) {
      ...
      world.capturedBlockStates.clear();
      if (blocks.size() > 1) {
        placeEvent = org.bukkit.craftbukkit.event.CraftEventFactory
            .callBlockMultiPlaceEvent(world, entityhuman, blocks, blockposition.getX(),
                blockposition.getY(), blockposition.getZ());
      } else if (blocks.size() == 1) {
        placeEvent = org.bukkit.craftbukkit.event.CraftEventFactory
            .callBlockPlaceEvent(world, entityhuman, blocks.get(0), blockposition.getX(),
                blockposition.getY(), blockposition.getZ());
      }
      ...
      if (placeEvent != null && (placeEvent.isCancelled() || !placeEvent.canBuild())) {
        ...
        for (BlockState blockstate : blocks) {
          ...
          world.notifyAndUpdatePhysics(newblockposition, null, oldBlock, block.getBlock(),
        ...
        if (this.getItem() instanceof ItemRecord) {
          ((BlockJukeBox) Blocks.JUKEBOX)
              .a(world, blockposition, world.getType(blockposition), this);
        ...
        if (this.getItem()
            == Items.SKULL) { // Special case skulls to allow wither spawns to be cancelled
  ...
  public NBTTagCompound save(NBTTagCompound nbttagcompound) {
    ...
    nbttagcompound
        .setString("id", minecraftkey == null ? "minecraft:air" : minecraftkey.toString());
    nbttagcompound.setByte("Count", (byte) this.count);
    nbttagcompound.setShort("Damage", (short) this.damage);
    if (this.tag != null) {
      nbttagcompound.set("tag",
  ...
  public void damage(int i, EntityLiving entityliving) {
    if (!(entityliving instanceof EntityHuman)
        || !((EntityHuman) entityliving).abilities.canInstantlyBuild) {
      if (this.e()) {
  ...
  public static boolean equals(ItemStack itemstack, ItemStack itemstack1) {
    return itemstack == null && itemstack1 == null || ((itemstack != null && itemstack1 != null)
        && ((itemstack.tag != null || itemstack1.tag == null) && (itemstack.tag == null
        || itemstack.tag.equals(itemstack1.tag))));
  }
  ...
  public static boolean matches(ItemStack itemstack, ItemStack itemstack1) {
    return itemstack == null && itemstack1 == null || ((itemstack != null && itemstack1 != null)
        && itemstack.d(itemstack1));
  }

  private boolean d(ItemStack itemstack) {
    return this.count == itemstack.count && (this.item == itemstack.item && (
        this.damage == itemstack.damage && ((this.tag != null || itemstack.tag == null) && (
            this.tag == null || this.tag.equals(itemstack.tag)))));
  }

  public static boolean c(ItemStack itemstack, ItemStack itemstack1) {
    return itemstack == null && itemstack1 == null || ((itemstack != null && itemstack1 != null)
        && itemstack.doMaterialsMatch(itemstack1));
  }
  ...
  public boolean hasName() {
    return this.tag != null && (this.tag.hasKeyOfType("display", 10) && this.tag
        .getCompound("display").hasKeyOfType("Name", 8));
  }
  ...
  public int getRepairCost() {
    return this.hasTag() && this.tag.hasKeyOfType("RepairCost", 3) ? this.tag.getInt("RepairCost")
        : 0;
  }
  ...
  public IChatBaseComponent C() {
    ...
    IChatBaseComponent ichatbasecomponent = (new ChatComponentText("["))
        .addSibling(chatcomponenttext).a("]");

    if (this.item != null) {
      NBTTagCompound nbttagcompound = new NBTTagCompound();

      this.save(nbttagcompound);
      ichatbasecomponent.getChatModifier().setChatHoverable(
