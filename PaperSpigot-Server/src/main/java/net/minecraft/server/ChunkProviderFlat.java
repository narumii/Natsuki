...
public class ChunkProviderFlat implements IChunkProvider {
  ...
  public ChunkProviderFlat(World world, long i, boolean flag, String s) {
    ...
    if (flag) {
      ...
      if (map.containsKey("mineshaft")
          && world.paperSpigotConfig.generateMineshaft) { // PaperSpigot
        this.e.add(new WorldGenMineshaft((Map) map.get("mineshaft")));
      }

      if (map.containsKey("stronghold")
          && world.paperSpigotConfig.generateStronghold) { // PaperSpigot
        this.e.add(new WorldGenStronghold((Map) map.get("stronghold")));
      }

      if (map.containsKey("oceanmonument")
          && world.paperSpigotConfig.generateMonument) { // PaperSpigot
    ...
    this.g = world.paperSpigotConfig.generateDungeon && this.d.b()
        .containsKey("dungeon");  // PaperSpigot
    int j = 0;
    int k = 0;
    boolean flag1 = true;
    ...
    while (iterator.hasNext()) {
      ...
      for (int l = worldgenflatlayerinfo.d();
          l < worldgenflatlayerinfo.d() + worldgenflatlayerinfo.b(); ++l) {
  ...
  public Chunk getOrCreateChunk(int i, int j) {
    ...
    BiomeBase[] abiomebase = this.a.getWorldChunkManager()
        .getBiomeBlock(null, i * 16, j * 16, 16, 16);
  ...
  public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
    ...
    if (this.i != null && !flag && this.b.nextInt(8) == 0) {
      BlockPosition blockposition1 = blockposition
          .a(this.b.nextInt(16) + 8, this.b.nextInt(this.b.nextInt(248) + 8),
              this.b.nextInt(16) + 8);
