    ...
    if (!world.isClientSide && entity instanceof EntityArrow) {
      ...
      if (entityarrow.isBurning()) {
        ...
        if (org.bukkit.craftbukkit.event.CraftEventFactory
            .callEntityChangeBlockEvent(entityarrow, blockposition.getX(), blockposition.getY(),
        ...
        this.a(world, blockposition,
            ...
            entityarrow.shooter instanceof EntityLiving ? (EntityLiving) entityarrow.shooter
                : null);
        world.setAir(blockposition);
      }
    }
