...
public class EntityMinecartCommandBlock extends EntityMinecartAbstract {
  ...
  private final CommandBlockListenerAbstract a = new CommandBlockListenerAbstract() {
    ...
    public void h() {
      ...
      EntityMinecartCommandBlock.this.getDataWatcher()
          .watch(24, IChatBaseComponent.ChatSerializer.a(this.k()));
    }

    public BlockPosition getChunkCoordinates() {
      return new BlockPosition(EntityMinecartCommandBlock.this.locX,
          EntityMinecartCommandBlock.this.locY + 0.5D, EntityMinecartCommandBlock.this.locZ);
    }
  ...
  protected void a(NBTTagCompound nbttagcompound) {
    ...
    this.getDataWatcher()
        .watch(24, IChatBaseComponent.ChatSerializer.a(this.getCommandBlock().k()));
  }
