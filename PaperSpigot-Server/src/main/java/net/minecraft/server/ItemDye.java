...
public class ItemDye extends Item {
  ...
  public static final int[] a = new int[]{1973019, 11743532, 3887386, 5320730, 2437522, 8073150,
      2651799, 11250603, 4408131, 14188952, 4312372, 14602026, 6719955, 12801229, 15435844,
      15790320};
  ...
  public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world,
    ...
    if (!entityhuman.a(blockposition.shift(enumdirection), enumdirection, itemstack)) {
      ...
      if (enumcolor == EnumColor.WHITE) {
        ...
        if (block == Blocks.LOG
            && iblockdata.get(BlockWood.VARIANT) == BlockWood.EnumLogVariant.JUNGLE) {
          ...
          if (world.isEmpty(blockposition)) {
            IBlockData iblockdata1 = Blocks.COCOA
                .getPlacedState(world, blockposition, enumdirection, f, f1, f2, 0, entityhuman);
  ...
  public static boolean a(ItemStack itemstack, World world, BlockPosition blockposition) {
    ...
    if (iblockdata.getBlock() instanceof IBlockFragilePlantElement) {
      IBlockFragilePlantElement iblockfragileplantelement = (IBlockFragilePlantElement) iblockdata
          .getBlock();
