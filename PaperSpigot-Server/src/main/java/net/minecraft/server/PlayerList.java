...
public abstract class PlayerList {
    ...
    private void addPacketDebugger(final PlayerConnection connection) throws IOException {
        ...
        final File file = new File("Debugger" + File.separator + connection.getPlayer().getName() + ".txt");

        final PrintStream printStream = new PrintStream(file);

        connection.networkManager.channel.pipeline().addBefore("packet_handler", connection.getPlayer().getName(), new ChannelDuplexHandler() {
            @Override
