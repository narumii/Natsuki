...
public class BlockLever extends Block {
  ...
  public static final BlockStateEnum<BlockLever.EnumLeverPosition> FACING = BlockStateEnum
      .of("facing", BlockLever.EnumLeverPosition.class);
  public static final BlockStateBoolean POWERED = BlockStateBoolean.of("powered");

  protected BlockLever() {
    super(Material.ORIENTABLE);
    this.j(this.blockStateList.getBlockData()
        .set(BlockLever.FACING, BlockLever.EnumLeverPosition.NORTH)
  ...
  public IBlockData getPlacedState(World world, BlockPosition blockposition,
    ...
    if (a(world, blockposition, enumdirection.opposite())) {
      ...
      } while (enumdirection1 == enumdirection || !a(world, blockposition,
          enumdirection1.opposite()));
  ...
  public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
    ...
    switch (BlockLever.SyntheticClass_1.b[iblockaccess.getType(blockposition).get(BlockLever.FACING)
        .ordinal()]) {
      case 1:
  ...
  public boolean interact(World world, BlockPosition blockposition, IBlockData iblockdata,
    ...
    if (world.isClientSide) {
      ...
      world.makeSound((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D,
          (double) blockposition.getZ() + 0.5D, "random.click", 0.3F,
  ...
  public IBlockData fromLegacyData(int i) {
    return this.getBlockData().set(BlockLever.FACING, BlockLever.EnumLeverPosition.a(i & 7))
        .set(BlockLever.POWERED, Boolean.valueOf((i & 8) > 0));
  }
  ...
  public enum EnumLeverPosition implements INamable {
    ...
    DOWN_X(0, "down_x", EnumDirection.DOWN), EAST(1, "east", EnumDirection.EAST), WEST(2, "west",
        EnumDirection.WEST), SOUTH(3, "south", EnumDirection.SOUTH), NORTH(4, "north",
        EnumDirection.NORTH), UP_Z(5, "up_z", EnumDirection.UP), UP_X(6, "up_x",
        EnumDirection.UP), DOWN_Z(7, "down_z", EnumDirection.DOWN);
    ...
    public static BlockLever.EnumLeverPosition a(EnumDirection enumdirection,
        EnumDirection enumdirection1) {
      switch (BlockLever.SyntheticClass_1.a[enumdirection.ordinal()]) {
        case 1:
    ...
    static {
      ...
      for (int j = 0; j < i; ++j) {
        ...
        BlockLever.EnumLeverPosition.i[blocklever_enumleverposition
