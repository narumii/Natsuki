...
public abstract class EntityAnimal extends EntityAgeable implements IAnimal {
  ...
  public boolean bR() {
    ...
    return this.world.getType(blockposition.down()).getBlock() == this.bn
        && this.world.k(blockposition) > 8 && super.bR();
  }
  ...
  public boolean mate(EntityAnimal entityanimal) {
    return entityanimal != this && (entityanimal.getClass() == this.getClass() && (this.isInLove()
