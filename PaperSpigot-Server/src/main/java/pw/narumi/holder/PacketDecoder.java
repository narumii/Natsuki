...
public class PacketDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext var1, ByteBuf var2, List<Object> var3) throws IOException, InstantiationException, IllegalAccessException {
        ...
        if (var6 == null) {
            ...
            if (var4.readableBytes() > 0) {
                throw new NatsukiException("Packet " + var1.channel().attr(NetworkManager.c).get().a() + "/" + var5 + " (" + var6.getClass().getSimpleName() + ") was larger than I expected, found " + var4.readableBytes() + " bytes extra whilst reading packet " + var5);
            } else {
                var3.add(var6);
                if (a.isDebugEnabled()) {
